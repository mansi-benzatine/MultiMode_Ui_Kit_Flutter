        ...
        child: Row(
          ...
          children: [
            ...
            if (isShowScan)
              InkWell(
                onTap: () {
                  clickListener.onTopBarClick(Constant.strScan);
                },
                child: Image.asset(
                  AppAssets.icTopBarScan,
                  width: 30.setWidth,
                  height: 30.setHeight,
                ),
              ),
            ...
            if (isShowDelete)
              InkWell(
                ...
                child: Image.asset(
                  ...
                  height: 24.setHeight,
                  width: 24.setWidth,
                  color: isDeleteEnabled ? (iconColor ?? CustomAppColor.of(context).txtBlack) : CustomAppColor.of(context).txtGray,
                ),
              ),
          ],
        ),
