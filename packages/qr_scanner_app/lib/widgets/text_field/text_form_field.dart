      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            contentPadding: EdgeInsets.only(right: 5.setWidth, left: 5.setWidth, top: 15.setHeight, bottom: 5.setHeight),
            border: UnderlineInputBorder(
              borderSide: BorderSide(color: CustomAppColor.of(context).containerBorder),
            ),
            enabledBorder: UnderlineInputBorder(
              borderSide: BorderSide(color: borderColor ?? CustomAppColor.of(context).containerBorder),
            ),
