...
class QrScannerApp extends StatefulWidget {
  ...
  static void setLocale(BuildContext context, Locale newLocale) {
    _QrScannerAppState? state = context.findAncestorStateOfType<_QrScannerAppState>();
  ...
  const QrScannerApp({super.key, this.externalThemeData});
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: QrScannerApp.navigatorKey,
...
class QrScannerAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const QrScannerAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = QrScannerApp.navigatorKey.currentState;
        ...
        child: QrScannerApp(externalThemeData: themeData),
      ),
    );
  }
}
