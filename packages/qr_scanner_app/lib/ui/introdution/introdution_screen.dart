...
class _IntroductionScreenState extends State<IntroductionScreen> implements TopBarClickListener {
  @override
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                padding: EdgeInsets.symmetric(horizontal: 25.setWidth, vertical: 16.setHeight),
                child: Column(
