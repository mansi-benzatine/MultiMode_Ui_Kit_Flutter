...
class _BarcodeOtherCodeScreenState extends State<BarcodeOtherCodeScreen> implements TopBarClickListener {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
        children: [
          TopBar(this, title: Languages.of(context).txtBarcodes2DCode, isShowBack: true),
          Expanded(
            child: Padding(
  ...
  void _onBarcodeTypeSelected(Map<String, dynamic> barcodeType) {
    Navigator.push(context, MaterialPageRoute(builder: (context) => CreateBarcodeScreen(barcodeType: barcodeType)));
  }
