...
class _CreateAppQrCodeScreenState extends State<CreateAppQrCodeScreen> implements TopBarClickListener {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            TopBar(this, title: Languages.of(context).txtCreateAppQrCode, isShowBack: true),
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => QrCodeResultScreen(qrType: appList[index])));
                    },
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Spacer(),
                          Icon(Icons.arrow_forward_ios, size: 16.setFontSize, color: CustomAppColor.of(context).primary),
                        ],
                      ),
                    ),
                  );
