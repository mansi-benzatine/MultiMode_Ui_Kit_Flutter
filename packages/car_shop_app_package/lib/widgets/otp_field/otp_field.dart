...
class _OTPTextFieldState extends State<OTPTextField> {
        ...
        return Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              counterText: "",
              contentPadding: EdgeInsets.symmetric(vertical: 20.setHeight, horizontal: 5.setWidth),
              border: _isFilled[i]!.value ? _getBorder(_otpFieldStyle.focusBorderColor) : _getBorder(_otpFieldStyle.borderColor),
              focusedBorder: _isFilled[i]!.value ? _getBorder(_otpFieldStyle.focusBorderColor) : _getBorder(_otpFieldStyle.borderColor),
              enabledBorder: _isFilled[i]!.value ? _getBorder(_otpFieldStyle.focusBorderColor) : _getBorder(_otpFieldStyle.enabledBorderColor),
              disabledBorder: _isFilled[i]!.value ? _getBorder(_otpFieldStyle.focusBorderColor) : _getBorder(_otpFieldStyle.disabledBorderColor),
  ...
  InputBorder _getBorder(Color color) {
    return widget.fieldStyle == FieldStyle.box
        ? OutlineInputBorder(borderSide: BorderSide(color: color), borderRadius: BorderRadius.circular(widget.outlineBorderRadius))
