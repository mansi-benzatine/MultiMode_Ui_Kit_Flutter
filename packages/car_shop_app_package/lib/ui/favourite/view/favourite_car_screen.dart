...
class _FavouriteCarScreenState extends State<FavouriteCarScreen> with TickerProviderStateMixin implements TopBarClickListener {
  ...
  initState() {
    ...
    carsByBrand = [
      PopularCarItem(carName: "Mercedes-Benz", carImage: AppAssets.imgMercedes2, carPrice: "\$32,340", carDescription: "New Looks, Longer Range, And Faster Charging Rate", carType: Constant.strNewCar),
      PopularCarItem(carName: "Mercedes", carImage: AppAssets.imgMercedes, carPrice: "\$32,340", carDescription: "New Looks, Longer Range, And Faster Charging Rate", carType: Constant.strUsedCar),
      PopularCarItem(carName: "Mercedes", carImage: AppAssets.imgMercedes, carPrice: "\$32,340", carDescription: "New Looks, Longer Range, And Faster Charging Rate", carType: Constant.strUsedCar),
      PopularCarItem(carName: "Tesla Model Y", carImage: AppAssets.imgTesla, carPrice: "\$32,340", carDescription: "New Looks, Longer Range, And Faster Charging Rate", carType: Constant.strNewCar),
    ];
  }
