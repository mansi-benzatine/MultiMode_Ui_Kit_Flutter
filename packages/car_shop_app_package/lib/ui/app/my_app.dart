import 'package:car_shop_app_package/ui/onboarding/on_boarding_screen.dart';
...
class CarShopApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _CarShopAppState? state = context.findAncestorStateOfType<_CarShopAppState>();
  ...
  const CarShopApp({super.key, this.externalThemeData});

  @override
  State<CarShopApp> createState() => _CarShopAppState();
}

class _CarShopAppState extends State<CarShopApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: CarShopApp.navigatorKey,
...
class CarShopAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const CarShopAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = CarShopApp.navigatorKey.currentState;
        ...
        child: CarShopApp(externalThemeData: themeData),
      ),
    );
  }
}
