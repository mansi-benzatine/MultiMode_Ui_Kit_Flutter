...
class MusifyApp extends StatefulWidget {
  ...
  static void setLocale(BuildContext context, Locale newLocale) {
    _MusifyAppState? state = context.findAncestorStateOfType<_MusifyAppState>();
  ...
  const MusifyApp({super.key, this.externalThemeData});
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: MusifyApp.navigatorKey,
...
class MusifyAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const MusifyAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = MusifyApp.navigatorKey.currentState;
        ...
        child: MusifyApp(externalThemeData: themeData),
      ),
    );
  }
}
