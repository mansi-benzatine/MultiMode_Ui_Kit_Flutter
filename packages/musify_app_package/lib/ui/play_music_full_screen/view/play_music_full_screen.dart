...
class PlayMusicFullScreen extends StatefulWidget {
  ...
  const PlayMusicFullScreen({super.key, this.musicItem});
...
class _PlayMusicFullScreenState extends State<PlayMusicFullScreen> implements TopBarClickListener {
              ...
              Expanded(
                child: CustomScrollView(
                  ...
                  slivers: [
                    ...
                    //     child: Column(
                    //       children: [
                    //         SizedBox(height: 0.screenHeight * 0.10),
                    //         Icon(
                    ...
                    //   ),
                    // SliverPadding(
                    //   padding: EdgeInsets.only(left: 30.setWidth, right: 30.setWidth, top: isCollapsed ? 0 : 20.setHeight),
                    //   sliver: SliverList(
                    ...
                    //         bool isHighlighted = line == "Roshni He" || line == "Chaar Soo Jo Chaar Soo";
  ...
  _sliverAppBar(MusicItemData currentMusic) {
    return SliverAppBar(
      expandedHeight: 0.screenHeight * 0.5,
      pinned: true,
    ...
    return SliverPersistentHeader(
      ...
      delegate: _SliverSongInfoDelegate(
        ...
        onPlayPauseClick: () {
          ...
          if (isPlaying) {
            MusifyApp.playingMusicNotifier.value = currentMusic;
          } else {
