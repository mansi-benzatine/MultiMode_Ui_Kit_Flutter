...
import 'package:furniture_app_package/ui/on_boarding/view/on_boarding_screen.dart';
...
class FurnitureApp extends StatefulWidget {
  ...
  static void setLocale(BuildContext context, Locale newLocale) {
    _FurnitureAppState? state = context.findAncestorStateOfType<_FurnitureAppState>();
  ...
  const FurnitureApp({super.key, this.externalThemeData});
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: FurnitureApp.navigatorKey,
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = FurnitureApp.navigatorKey.currentState;
        ...
        child: FurnitureApp(externalThemeData: themeData),
      ),
    );
  }
}
