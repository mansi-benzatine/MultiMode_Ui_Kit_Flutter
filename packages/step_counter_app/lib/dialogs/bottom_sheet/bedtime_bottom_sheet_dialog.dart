...
class BedTimeBottomSheetDialog extends StatefulWidget {
  const BedTimeBottomSheetDialog({super.key, required this.onSave, required this.isBedTime});

  final Function() onSave;
  final bool isBedTime;

  @override
  State<BedTimeBottomSheetDialog> createState() => _BedTimeBottomSheetDialogState();
}

class _BedTimeBottomSheetDialogState extends State<BedTimeBottomSheetDialog> {
