...
extension SizeExtension on num {
  ...
  static double setFontSizeCustom(double size) {
    ...
    final context = StepCounterApp.navigatorKey.currentContext!;
...
// Add a helper method to detect foldable phones
  ...
  double get bottomPadding => (MediaQuery.of(StepCounterApp.navigatorKey.currentContext!).padding.bottom + 10).setHeight;
  double get topPadding => (MediaQuery.of(StepCounterApp.navigatorKey.currentContext!).padding.top + 10).setHeight;
}
