...
class StepCounterApp extends StatefulWidget {
  ...
  static void setLocale(BuildContext context, Locale newLocale) {
    _StepCounterAppState? state = context.findAncestorStateOfType<_StepCounterAppState>();
  ...
  const StepCounterApp({super.key, this.externalThemeData});
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: StepCounterApp.navigatorKey,
...
class StepCounterAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const StepCounterAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = StepCounterApp.navigatorKey.currentState;
        ...
        child: StepCounterApp(externalThemeData: themeData),
      ),
    );
  }
}
