...
class DistanceResultScreen extends StatefulWidget {
  const DistanceResultScreen({super.key});

  static Route<void> route() {
    return MaterialPageRoute<void>(builder: (context) => const DistanceResultScreen());
  }

  @override
  State<DistanceResultScreen> createState() => _DistanceResultScreenState();
}

class _DistanceResultScreenState extends State<DistanceResultScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Image.asset(AppAssets.imgBgDistanceResult),
          Positioned(
            top: 120.setHeight,
