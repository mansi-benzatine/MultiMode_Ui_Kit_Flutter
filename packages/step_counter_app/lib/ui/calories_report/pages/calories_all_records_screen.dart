...
class CaloriesAllRecordsScreen extends StatefulWidget {
  const CaloriesAllRecordsScreen({super.key});

  static Route<void> route() {
    return MaterialPageRoute<void>(builder: (context) => const CaloriesAllRecordsScreen());
  }

  @override
  State<CaloriesAllRecordsScreen> createState() => _CaloriesAllRecordsScreenState();
}

class _CaloriesAllRecordsScreenState extends State<CaloriesAllRecordsScreen> implements TopBarClickListener {
  @override
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: CommonText(
                            text: Languages.of(context).txtCalories.toUpperCase(),
