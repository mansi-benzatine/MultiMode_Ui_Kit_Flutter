...
import 'package:step_counter_app_package/ui/subscription/view/subscription_screen.dart';
import 'package:step_counter_app_package/utils/app_assets.dart';
import 'package:step_counter_app_package/utils/debug.dart';
                      ...
                      builder: (context, value, child) {
                        return FlutterSwitch(
                          ...
                          onToggle: (bool newValue) async {
                            ...
                            StepCounterApp.changeTheme(context, newTheme);
                          },
                          activeColor: CustomAppColor.of(context).primary,
                          inactiveColor: CustomAppColor.of(context).txtBlack.withValues(alpha: 0.1),
                          activeToggleColor: CustomAppColor.of(context).white,
