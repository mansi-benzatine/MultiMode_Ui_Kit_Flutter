...
class NotificationsScreen extends StatefulWidget {
  final bool isFromEmptyNotification;
  static Route<void> route({required bool isFromEmptyNotification}) {
    return MaterialPageRoute(builder: (_) => NotificationsScreen(isFromEmptyNotification: isFromEmptyNotification));
  }

  const NotificationsScreen({super.key, required this.isFromEmptyNotification});
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    const IgnorePointer(ignoring: true, child: _SearchInputView()),
                    widget.isFromEmptyNotification ? const EmptyView() : _NotificationListView(notificationList: notificationsList)
                  ],
                ),
              ),
            ),
