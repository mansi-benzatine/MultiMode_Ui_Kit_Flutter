...
class JobFinderScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _JobFinderScreensAppState? state = context.findAncestorStateOfType<_JobFinderScreensAppState>();
  ...
  const JobFinderScreensApp({super.key, this.externalThemeData});

  @override
  State<JobFinderScreensApp> createState() => _JobFinderScreensAppState();
}

class _JobFinderScreensAppState extends State<JobFinderScreensApp> {
  Locale? locale;
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          value: SystemUiOverlayStyle(
            ...
            statusBarBrightness: Utils.isDarkTheme() ? Brightness.dark : Brightness.light, // iOS
            statusBarColor: CustomAppColor.of(context).transparent,
          ),
          child: MaterialApp(
            navigatorKey: JobFinderScreensApp.navigatorKey,
...
class JobFinderScreensList extends StatelessWidget {
  final ThemeData themeData;
  const JobFinderScreensList({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = JobFinderScreensApp.navigatorKey.currentState;
        ...
        child: JobFinderScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
