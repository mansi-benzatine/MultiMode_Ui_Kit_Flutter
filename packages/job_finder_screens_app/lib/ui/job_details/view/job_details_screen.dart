...
class JobDetailsScreen extends StatefulWidget {
  ...
  static Route<void> route({required bool isFromDescription, required bool isFromCompany, required bool isFromReview}) {
    return MaterialPageRoute(
      builder: (_) => JobDetailsScreen(
        isFromCompany: isFromCompany,
        isFromDescription: isFromDescription,
        isFromReview: isFromReview,
      ),
    );
  }

  const JobDetailsScreen({super.key, required this.isFromDescription, required this.isFromCompany, required this.isFromReview});
...
class _JobDetailsScreenState extends State<JobDetailsScreen> implements TopBarClickListener {
  ...
  void fillData() {
    ...
    companyDataList = [
      ...
      CompanyData(
        imagePath: AppAssets.icWhiteLocation,
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return GestureDetector(
                                ...
                                child: IgnorePointer(
                                  ignoring: (selectedIndex == 0 && widget.isFromDescription)
                                      ? true
                                      : (selectedIndex == 1 && widget.isFromCompany)
                                          ? true
                                          : (selectedIndex == 2 && widget.isFromReview)
                                              ? true
                                              : false,
                                  child: Container(
                                    width: 110.setWidth,
