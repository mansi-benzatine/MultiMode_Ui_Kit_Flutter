...
class ProfileUpdateCardView extends StatefulWidget {
  ...
  const ProfileUpdateCardView({super.key, required this.switchValue});

  @override
  State<ProfileUpdateCardView> createState() => _ProfileUpdateCardViewState();
}

class _ProfileUpdateCardViewState extends State<ProfileUpdateCardView> {
  @override
  Widget build(BuildContext context) {
    return Padding(
