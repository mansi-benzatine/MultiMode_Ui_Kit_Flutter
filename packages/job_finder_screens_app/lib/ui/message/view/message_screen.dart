...
class MessageScreen extends StatefulWidget {
  ...
  const MessageScreen({
    super.key,
    required this.isFromEmptyMessage,
  });
  static Route<void> route({required bool isFromEmptyMessage}) {
    return MaterialPageRoute(builder: (_) => MessageScreen(isFromEmptyMessage: isFromEmptyMessage));
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        (filteredMessageList.isNotEmpty && (!widget.isFromEmptyMessage))
            ? _MessageListView(messageList: filteredMessageList)
