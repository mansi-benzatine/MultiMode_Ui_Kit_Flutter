...
import 'package:taxi_booking_driver_app_package/utils/utils.dart';
...
class CustomAppColor {
  ...
  Color get btnBorder {
    return (Theme.of(context).brightness == Brightness.light)
        ? const Color(0xFF0D1722)
        : const Color(0xFF9EA2A7).withValues(alpha: 0.5);
  }

  Color get txtGreyWhite {
    return (Theme.of(context).brightness == Brightness.light)
        ? const Color(0xFFCFD1D3)
        : Colors.white;
  }

  Color get borderTextFormField {
    return (Theme.of(context).brightness == Brightness.light)
        ? const Color(0xFFCFD1D3).withOpacityPercent(0.4)
        : Colors.white.withOpacityPercent(0.1);
  }
  ...
  Color get bgCallActionBlue {
    return (Theme.of(context).brightness == Brightness.light)
        ? const Color(0xFF598FFF)
        : CustomAppColor.of(context).black.withValues(alpha: 0.3);
  }
