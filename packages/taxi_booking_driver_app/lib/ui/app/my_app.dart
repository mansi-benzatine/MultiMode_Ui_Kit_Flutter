...
class TaxiBookingDriverApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _TaxiBookingDriverAppState? state =
        context.findAncestorStateOfType<_TaxiBookingDriverAppState>();
  ...
  const TaxiBookingDriverApp({super.key, this.externalThemeData});

  @override
  State<TaxiBookingDriverApp> createState() => _TaxiBookingDriverAppState();
}

class _TaxiBookingDriverAppState extends State<TaxiBookingDriverApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: TaxiBookingDriverApp.navigatorKey,
...
class TaxiBookingDriverAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const TaxiBookingDriverAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = TaxiBookingDriverApp.navigatorKey.currentState;
        ...
        child: TaxiBookingDriverApp(externalThemeData: themeData),
      ),
    );
  }
}
