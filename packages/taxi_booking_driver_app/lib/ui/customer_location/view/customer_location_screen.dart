...
import 'package:taxi_booking_driver_app_package/ui/arrived_at_location/view/arrived_at_location_screen.dart';
...
class CustomerLocationScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const CustomerLocationScreen());
  }
