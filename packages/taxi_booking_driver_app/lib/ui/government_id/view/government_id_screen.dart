...
class GovernmentIdScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const GovernmentIdScreen());
  }
...
class _GovernmentIdScreenState extends State<GovernmentIdScreen> implements TopBarClickListener {
