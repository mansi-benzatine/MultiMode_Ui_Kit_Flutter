...
import 'package:stoxy_app_package/ui/buy_method/view/buy_method_screen.dart';
...
class BuyScreen extends StatefulWidget {
  ...
  static Route<void> route({required WishListItemData data}) {
    return MaterialPageRoute(builder: (_) => BuyScreen(data: data));
  }

  const BuyScreen({super.key, required this.data});

  @override
  State<BuyScreen> createState() => _BuyScreenState();
}

class _BuyScreenState extends State<BuyScreen> implements TopBarClickListener {
            ...
            children: [
              ...
              Padding(
                ...
                child: CommonButton(
                  ...
                  onTap: () => Navigator.push(context, BuyMethodScreen.route(data: widget.data)),
