...
import 'package:stoxy_app_package/dialogs/alerts/order_exchange_received_dialog.dart';
...
class PreviewExchangeScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const PreviewExchangeScreen());
  }

  const PreviewExchangeScreen({super.key});
