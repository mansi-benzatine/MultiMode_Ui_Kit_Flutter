...
class StoxyApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _StoxyAppState? state = context.findAncestorStateOfType<_StoxyAppState>();
  ...
  const StoxyApp({super.key, this.externalThemeData});

  @override
  State<StoxyApp> createState() => _StoxyAppState();
}

class _StoxyAppState extends State<StoxyApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: StoxyApp.navigatorKey,
...
class StoxyAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const StoxyAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = StoxyApp.navigatorKey.currentState;
        ...
        child: StoxyApp(externalThemeData: themeData),
      ),
    );
  }
}
