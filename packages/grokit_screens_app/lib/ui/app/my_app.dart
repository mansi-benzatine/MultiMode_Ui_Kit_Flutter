...
import 'package:grokit_screens_app/ui/screens_list/view/screens_list_screen.dart';
...
class GroKitScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _GroKitScreensAppState? state = context.findAncestorStateOfType<_GroKitScreensAppState>();
  ...
  const GroKitScreensApp({super.key, this.externalThemeData});

  @override
  State<GroKitScreensApp> createState() => _GroKitScreensAppState();
}

class _GroKitScreensAppState extends State<GroKitScreensApp> {
  Locale? _locale;
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          value: SystemUiOverlayStyle(
            ...
            statusBarBrightness: Utils.isLightTheme() ? Brightness.dark : Brightness.dark, // iOS
          ),
          child: MaterialApp(
            navigatorKey: GroKitScreensApp.navigatorKey,
...
class GroKitScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const GroKitScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = GroKitScreensApp.navigatorKey.currentState;
        ...
        child: GroKitScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
