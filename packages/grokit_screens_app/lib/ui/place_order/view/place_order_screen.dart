...
class PlaceOrderScreen extends StatefulWidget {
  final bool isShowPlaceOrderPopUp;

  static Route<void> route({bool isShowPlaceOrderPopUp = false}) {
    return MaterialPageRoute(
      builder: (_) => PlaceOrderScreen(isShowPlaceOrderPopUp: isShowPlaceOrderPopUp),
    );
  }

  const PlaceOrderScreen({super.key, this.isShowPlaceOrderPopUp = false});
...
class _PlaceOrderScreenState extends State<PlaceOrderScreen> implements TopBarClickListener {
  ...
  void initState() {
    ...
    if (widget.isShowPlaceOrderPopUp) {
