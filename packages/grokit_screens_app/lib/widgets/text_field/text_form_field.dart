        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
              ...
              borderSide: BorderSide(width: 0.5, color: CustomAppColor.of(context).black.withOpacityPercent(0.08)),
            ),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(
                width: 0.5,
                color: widget.borderColor ?? CustomAppColor.of(context).borderTextFormField,
              ),
            ),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(width: 0.5, color: CustomAppColor.of(context).btnPrimary),
            ),
            ...
            disabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(width: 0.5, color: CustomAppColor.of(context).borderTextFormField),
            ),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
                ...
                ? InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Image.asset(
                        ...
                        height: 18.setHeight,
                        width: 18.setHeight,
                        color: (isFocused || isEmpty) ? CustomAppColor.of(context).txtBlackGrey : widget.prefixIconColor,
                        gaplessPlayback: true,
                      ),
                    ),
                  )
            ...
            border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(color: CustomAppColor.of(context).borderTextFormField, width: 0.5),
            ),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(color: CustomAppColor.of(context).borderTextFormField, width: 0.5),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(color: widget.borderColor ?? CustomAppColor.of(context).borderTextFormField, width: 0.5),
            ),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(color: widget.borderColor ?? CustomAppColor.of(context).borderTextFormField, width: 0.5),
            ...
            errorBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(color: widget.borderColor ?? CustomAppColor.of(context).txtRed.withOpacityPercent(0.30), width: 0.5),
            ),
          ),
        ),
      ],
