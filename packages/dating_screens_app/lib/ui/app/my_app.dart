...
class DatingScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _DatingScreenAppState? state = context.findAncestorStateOfType<_DatingScreenAppState>();
  ...
  const DatingScreensApp({super.key, this.externalThemeData});

  @override
  State<DatingScreensApp> createState() => _DatingScreenAppState();
}

class _DatingScreenAppState extends State<DatingScreensApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return MaterialApp(
          ...
          navigatorKey: DatingScreensApp.navigatorKey,
          ...
          home: DatingAppScreenListScreen(
            title: 'Dating App ',
            onBack: () {
...
class DatingScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;
  const DatingScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = DatingScreensApp.navigatorKey.currentState;
        ...
        child: DatingScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
