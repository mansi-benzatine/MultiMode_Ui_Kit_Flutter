...
import 'package:cinemix_screens_app/ui/home/page/horizontal_movie_list.dart';
...
import 'package:cinemix_screens_app/widgets/alert_dialog/download_alert_dialog.dart';
import 'package:cinemix_screens_app/widgets/alert_dialog/review_alert_dialog.dart';
import 'package:cinemix_screens_app/widgets/bottom_sheet/share_bottom_sheet.dart';
...
class ExploreMovieScreen extends StatefulWidget {
  ...
  final bool isShowDownloadAlert;
  final bool isShowReviewAlert;
  final bool isShowShareBs;

  static Route<void> route({
    required Movie movie,
    bool isFromContinueWatching = false,
    bool isShowDownloadAlert = false,
    bool isShowReviewAlert = false,
    bool isShowShareAlert = false,
  }) {
    return MaterialPageRoute(
      builder: (_) => ExploreMovieScreen(
        movie: movie,
        isFromContinueWatching: isFromContinueWatching,
        isShowDownloadAlert: isShowDownloadAlert,
        isShowReviewAlert: isShowReviewAlert,
        isShowShareBs: isShowShareAlert,
      ),
    );
  }
  ...
  const ExploreMovieScreen({
    ...
    this.isShowReviewAlert = false,
    this.isShowShareBs = false,
  });
