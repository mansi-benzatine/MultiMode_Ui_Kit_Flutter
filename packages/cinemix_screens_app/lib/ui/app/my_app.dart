import 'package:cinemix_screens_app/ui/screens_list/view/screens_list_screen.dart';
...
class CinemixScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _CinemixScreensAppState? state = context.findAncestorStateOfType<_CinemixScreensAppState>();
  ...
  const CinemixScreensApp({super.key, this.externalThemeData});

  @override
  State<CinemixScreensApp> createState() => _CinemixScreensAppState();
}

class _CinemixScreensAppState extends State<CinemixScreensApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: CinemixScreensApp.navigatorKey,
...
class CinemixScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const CinemixScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = CinemixScreensApp.navigatorKey.currentState;
        ...
        child: CinemixScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
