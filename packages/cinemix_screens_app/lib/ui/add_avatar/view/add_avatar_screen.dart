...
class AddAvatarScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const AddAvatarScreen());
  }
...
class _AddAvatarScreenState extends State<AddAvatarScreen> implements TopBarClickListener {
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            TopBar(
              this,
              title: Languages.of(context).txtAddProfile,
              isShowBack: true,
