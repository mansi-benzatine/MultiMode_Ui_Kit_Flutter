...
import 'package:qr_scanner_screens_app_package/ui/onboarding/datamodel/onboarding_data.dart';
...
class OnboardingScreen extends StatefulWidget {
  ...
  static Route route({required int currentIndex}) {
    return MaterialPageRoute(
        builder: (context) => OnboardingScreen(currentIndex: currentIndex));
  }
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void initState() {
    ...
    // Delay ensures widgets are mounted before jump
                ...
                children: [
                    ...
                    IgnorePointer(
                      ...
                      child: Container(
                        ...
                        margin: EdgeInsets.only(
                            right: 20.setWidth, top: 20.setHeight),
                        child: InkWell(
                          onTap: () {
                            pageController.animateToPage(
                                onBoardingList(context).length - 1,
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(
                        vertical: 20.setHeight, horizontal: 18.setWidth),
                    child: IgnorePointer(
                      ignoring: true,
                      child: CommonButton(
