...
class HistoryScreen extends StatefulWidget {
  final bool isEmptyScreenShown;
  final bool isDeleteAlertShown;
  const HistoryScreen({super.key, this.isEmptyScreenShown = false, this.isDeleteAlertShown = false});
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            CommonText(
                                              ...
                                              maxLines: 1,
                                              textColor: (historyList?[index]['isSelected']) ? CustomAppColor.of(context).txtWhite : CustomAppColor.of(context).txtBlack,
                                            ),
                                            ...
                                            CommonText(
                                              ...
                                              textColor: (historyList?[index]['isSelected']) ? CustomAppColor.of(context).txtWhite : CustomAppColor.of(context).txtDarkGray,
                                            ),
                                            ...
                                            Row(
                                              children: [
                                                Image.asset(
                                                  ...
                                                  height: 14.setHeight,
                                                  width: 14.setWidth,
                                                  color: (historyList?[index]['isSelected']) ? CustomAppColor.of(context).txtWhite : CustomAppColor.of(context).primary,
                                                ),
