...
class _ScanScreenState extends State<ScanScreen>
  ...
  Future<void> _initializeCamera() async {
    try {
      ...
      Debug.printLog(
          'ScanScreen: Current camera permission status: $currentStatus');

      // Request camera permission
      final cameraPermission = await Permission.camera.request();
      Debug.printLog(
          'ScanScreen: Camera permission request result: $cameraPermission');

      if (cameraPermission != PermissionStatus.granted) {
        Debug.printLog(
            'ScanScreen: Camera permission denied - $cameraPermission');
        if (mounted) {
          setState(() {
      ...
      if (_cameras.isNotEmpty) {
        ...
        Debug.printLog(
            'ScanScreen: Camera controller initialized successfully');
  ...
  Future<void> _flipCamera() async {
    ...
    try {
      ...
      int currentIndex = _cameras.indexWhere((c) =>
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            CommonText(
                              text: _hasInitialized
                                  ? Languages.of(context).txtInitializingCamera
                                  : Languages.of(context)
                                      .txtRequestingCameraPermission,
              ...
              children: [
                CommonText(
                  text: Languages.of(context)
                      .txtPutTheQrOrBarcodeInsideRectangleBoxToScan,
                  textColor: CustomAppColor.of(context).white,
