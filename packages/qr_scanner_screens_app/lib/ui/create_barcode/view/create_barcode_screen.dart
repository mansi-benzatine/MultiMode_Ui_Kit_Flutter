...
class CreateBarcodeScreen extends StatefulWidget {
  ...
  static Route<void> route({required Map<String, dynamic> barcodeType}) {
    return MaterialPageRoute(
        builder: (_) => CreateBarcodeScreen(barcodeType: barcodeType));
  }
...
class _CreateBarcodeScreenState extends State<CreateBarcodeScreen>
    ...
    switch (barcodeType) {
      ...
      case Constant.toolCODE93:
        return CommonTextFormField(
          ...
          hintText: Languages.of(context)
              .txtPleaseTypeAlphabetsAndNumbersOrSomeCharacters,
          maxLines: 6,
      ...
      case Constant.toolPDF417:
        return CommonTextFormField(
          controller: TextEditingController(),
          hintText: Languages.of(context)
              .txtPleaseTypeAlphabetsAndNumbersAndCharacters,
        );
      case Constant.toolCODEBAR:
        return CommonTextFormField(
          controller: TextEditingController(),
  ...
  void _onGeneratePressed() {
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                BarcodeResultScreen(barcodeType: widget.barcodeType)));
  }
