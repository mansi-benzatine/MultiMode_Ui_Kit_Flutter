...
import 'package:qr_scanner_screens_app_package/widgets/button/common_button.dart';
...
class ProVersionScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const ProVersionScreen());
  }
            ...
            Expanded(
              child: SingleChildScrollView(
                padding: EdgeInsets.symmetric(
                    horizontal: 24.setWidth, vertical: 16.setHeight),
                child: Column(
                  children: [
                    Stack(
                                ...
                                children: [
                                  ...
                                  CommonText(
                                    text: Languages.of(context)
                                        .txtSubscribeToUnlockAllTheFunctionalityOfTheApplication,
