...
import 'package:qr_scanner_screens_app_package/widgets/text/common_text.dart';
import 'package:qr_scanner_screens_app_package/widgets/top_bar/topbar.dart';
              ...
              child: Padding(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      _buildQrTypeCard(_qrTypes[index]),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: CustomAppColor.of(context).generateQrCardBorder),
          ),
          child: Column(
  ...
  void _onQrTypeSelected(Map<String, dynamic> qrType) {
    ...
    if (qrType['type'] == Constant.toolApp) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => const CreateAppQrCodeScreen()));
    } else if (qrType['type'] == Constant.toolBarcodes2DCode) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => const BarcodeOtherCodeScreen()));
    } else {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => CreateQrCodeScreen(qrType: qrType)));
    }
  }
