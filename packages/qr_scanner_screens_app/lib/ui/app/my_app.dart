...
import 'package:qr_scanner_screens_app_package/ui/screens_list/views/screens_list_screen.dart';
...
class QrScannerScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _QrScannerScreensAppState? state =
        context.findAncestorStateOfType<_QrScannerScreensAppState>();
  ...
  const QrScannerScreensApp({super.key, this.externalThemeData});

  @override
  State<QrScannerScreensApp> createState() => _QrScannerScreensAppState();
}

class _QrScannerScreensAppState extends State<QrScannerScreensApp> {
  Locale? _locale;
...
*/
  ...
  void _updateLocalStorageFromTheme(ThemeData themeData) {
    ...
    getIt
        ...
        .setBool(LocalStorageService.isLightTheme, isLightTheme);
  }
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          value: SystemUiOverlayStyle(
            ...
            statusBarBrightness: Utils.isLightTheme()
                ? Brightness.light
                : Brightness.dark, // iOS
            statusBarColor: CustomAppColor.of(context).transparent,
          ),
          child: MaterialApp(
            navigatorKey: QrScannerScreensApp.navigatorKey,
...
class QrScannerScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const QrScannerScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = QrScannerScreensApp.navigatorKey.currentState;
        ...
        child: QrScannerScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
