                ...
                children: [
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Image.asset(
                              favouriteIndices.contains(index) || (widget.isFilledFavouriteVisible ?? false)
                                  ? AppAssets.icFilledFavourite
                                  : AppAssets.icHeart,
                              width: favouriteIndices.contains(index) || (widget.isFilledFavouriteVisible ?? false)
                                  ? AppSizes.setWidth(20)
                                  : AppSizes.setWidth(24),
                              height: favouriteIndices.contains(index) || (widget.isFilledFavouriteVisible ?? false)
                                  ? AppSizes.setHeight(19)
                                  : AppSizes.setHeight(24),
                              color: favouriteIndices.contains(index)
                                  ? null
                                  : (widget.isFilledFavouriteVisible ?? false)
                                      ? null
                  ...
                  Padding(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        if (widget.isImageBorderVisible ?? false)
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  ...
                                  height: AppSizes.setHeight(124),
                                  width: widget.imageWidth ?? AppSizes.setWidth(89),
                                  fit: BoxFit.fill,
                                ),
                              ),
                            ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: widget.isShowMrp ?? false ? AppSizes.setHeight(10) : AppSizes.setHeight(10)),
                              Visibility(
                                visible: widget.isShowMrp ?? false,
                                child: Row(
                                  children: [
                                    CommonText(
                              ...
                              Visibility(
                                visible: widget.isShowTrusted ?? false,
                                child: Padding(
                              ...
                              Visibility(
                                visible: widget.isRatingShown ?? false,
                                child: Row(
                                  children: [
                                    Container(
                              ...
                              Visibility(
                                visible: !(widget.isDownloadVisible ?? false),
                                child: Padding(
                                  padding: widget.isRatingShown ?? false
                          ...
                          return Padding(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                  color: CustomAppColor.of(context).white,
                                  border: Border.all(
                                      color: widget.isImageBorderVisible ?? false
