...
import 'package:goozzy_e_commerce_app_package/ui/app/my_app.dart';
...
class AppSizes {
  ...
  static setFontSize(s) {
    return setFontSizeCustom(double.parse(s.toString()));
  }
/*
  ...
  static double setFontSizeCustom(double size) {
    ...
    final context = GoozzyECommerceMyApp.navigatorKey.currentContext!;
