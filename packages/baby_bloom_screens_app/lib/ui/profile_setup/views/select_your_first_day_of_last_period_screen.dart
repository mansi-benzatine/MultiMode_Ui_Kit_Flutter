...
class SelectYourFirstDayOfLastPeriodScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const SelectYourFirstDayOfLastPeriodScreen());
  }

  const SelectYourFirstDayOfLastPeriodScreen({super.key});

  @override
  State<SelectYourFirstDayOfLastPeriodScreen> createState() => _SelectYourFirstDayOfLastPeriodScreenState();
}

class _SelectYourFirstDayOfLastPeriodScreenState extends State<SelectYourFirstDayOfLastPeriodScreen> implements TopBarClickListener {
          ...
          children: [
            ...
            Column(
              children: [
                TopBar(
                  this,
                  title: Languages.of(context).txtFirstDayOfLastPeriod,
                  isShowBack: true,
  ...
  _calenderView() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          CommonText(
            text: Languages.of(context).txtFirstDayOfLastPeriodDesc,
