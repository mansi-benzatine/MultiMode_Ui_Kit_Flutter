...
class EstimatedDueDateScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const EstimatedDueDateScreen());
  }

  const EstimatedDueDateScreen({super.key});

  @override
  State<EstimatedDueDateScreen> createState() => _EstimatedDueDateScreenState();
}

class _EstimatedDueDateScreenState extends State<EstimatedDueDateScreen> implements TopBarClickListener {
          ...
          children: [
            ...
            Column(
              children: [
                TopBar(
                  this,
                  title: Languages.of(context).txtEstimateDueDate,
                  isShowBack: true,
  ...
  _calenderView() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          CommonText(
            text: Languages.of(context).txtEstimateDueDateDesc,
