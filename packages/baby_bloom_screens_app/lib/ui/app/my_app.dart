import 'package:baby_bloom_screens_app/ui/screens_list/view/screens_list_screen.dart';
...
class BabyBloomScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _BabyBloomScreensAppState? state = context.findAncestorStateOfType<_BabyBloomScreensAppState>();
  ...
  const BabyBloomScreensApp({super.key, this.externalThemeData});

  @override
  State<BabyBloomScreensApp> createState() => _BabyBloomScreensAppState();
}

class _BabyBloomScreensAppState extends State<BabyBloomScreensApp> {
  Locale? _locale;
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          value: SystemUiOverlayStyle(
            ...
            statusBarBrightness: Utils.isLightTheme() ? Brightness.dark : Brightness.dark,
          ),
          child: MaterialApp(
            navigatorKey: BabyBloomScreensApp.navigatorKey,
...
class BabyBloomScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const BabyBloomScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = BabyBloomScreensApp.navigatorKey.currentState;
        ...
        child: BabyBloomScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
