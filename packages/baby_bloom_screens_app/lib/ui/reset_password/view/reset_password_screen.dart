...
import 'package:baby_bloom_screens_app/widgets/alert_dialog/reset_password_success_dialog.dart';
...
class ResetPasswordScreen extends StatefulWidget {
  final bool isShowResetAlert;

  static Route<void> route({bool isShowResetAlert = false}) {
    return MaterialPageRoute(builder: (_) => ResetPasswordScreen(isShowResetAlert: isShowResetAlert));
  }

  const ResetPasswordScreen({super.key, this.isShowResetAlert = false});
