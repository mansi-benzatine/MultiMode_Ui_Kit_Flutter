...
import 'package:baby_bloom_screens_app/widgets/bottom_sheet/add_event_bottom_sheet.dart';
  ...
  static Route<void> route({
    ...
    return MaterialPageRoute(
      builder: (_) => CalendarScreen(
        ...
        isForScheduledEventsPastBs: isForScheduledEventsFutureBs,
      ),
    );
  }
...
class _CalendarScreenState extends State<CalendarScreen> implements TopBarClickListener {
  ...
  List<Event> eventsFutureDemo = [];
  List<Event> eventsPastDemo = [];

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    eventsFutureDemo = _markedDateMap.getEvents(DateTime(2026, 12, 20));
    eventsPastDemo = _markedDateMap.getEvents(DateTime(2025, 10, 10));

    if (widget.isForNoEventBs) {
    ...
    if (widget.isForScheduledEventsFutureBs) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        setState(() {
          _isBottomSheetOpen = true;
        });
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CommonText(
                          text: DateFormat('EEEE, MMMM dd').format(DateTime(2026, 12, 20)),
                          fontFamily: Constant.fontFamilySemiBold600,
                          fontSize: 16.setFontSize,
                        ),
                        if (DateTime(2026, 12, 20).isAfter(DateTime.now())) const Icon(Icons.add)
                      ],
                    ),
                    SizedBox(height: 12.setHeight),
                    Column(
                      children: eventsFutureDemo.map((event) {
                        return Container(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  if (DateTime(2026, 12, 20).isAfter(DateTime.now()))
                                    Image.asset(
                                      AppAssets.icEdit,
                                      height: 16.setHeight,
                                      width: 16.setWidth,
    ...
    if (widget.isForScheduledEventsPastBs) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        setState(() {
          _isBottomSheetOpen = true;
        });
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CommonText(
                          text: DateFormat('EEEE, MMMM dd').format(DateTime(2025, 10, 10)),
                          fontFamily: Constant.fontFamilySemiBold600,
                          fontSize: 16.setFontSize,
                        ),
                        if (DateTime(2025, 10, 10).isAfter(DateTime.now())) const Icon(Icons.add)
                      ],
                    ),
                    SizedBox(height: 12.setHeight),
                    Column(
                      children: eventsPastDemo.map((event) {
                        return Container(
                          margin: EdgeInsets.only(bottom: 15.setHeight),
                          padding: EdgeInsets.all(12.setHeight),
                          decoration: BoxDecoration(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  event.icon ?? const Icon(Icons.event, color: Colors.pink),
                                  SizedBox(width: 12.setWidth),
                                  if (DateTime(2025, 10, 10).isAfter(DateTime.now()))
                                    Image.asset(
                                      AppAssets.icEdit,
                                      height: 16.setHeight,
                                      width: 16.setWidth,
