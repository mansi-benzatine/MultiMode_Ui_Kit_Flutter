...
import 'package:stoxy_screens_app_package/dialogs/alerts/order_received_dialog.dart';
...
class PreviewSellScreen extends StatefulWidget {
  ...
  static Route<void> route({required WishListItemData data, bool isShowDialog = false}) {
    return MaterialPageRoute(
      builder: (_) => PreviewSellScreen(data: data, isShowDialog: isShowDialog),
    );
  }

  const PreviewSellScreen({super.key, required this.data, this.isShowDialog = false});
