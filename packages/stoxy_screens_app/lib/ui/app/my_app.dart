...
import 'package:stoxy_screens_app_package/ui/screens_list/view/screens_list_screen.dart';
...
class StoxyScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _StoxyScreensAppState? state = context.findAncestorStateOfType<_StoxyScreensAppState>();
  ...
  const StoxyScreensApp({super.key, this.externalThemeData});

  @override
  State<StoxyScreensApp> createState() => _StoxyScreensAppState();
}

class _StoxyScreensAppState extends State<StoxyScreensApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: StoxyScreensApp.navigatorKey,
            ...
            home:  ScreenListScreen(title: "Stoxy - Stock Market App",onBack: () {
...
class StoxyScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const StoxyScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = StoxyScreensApp.navigatorKey.currentState;
        ...
        child: StoxyScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
