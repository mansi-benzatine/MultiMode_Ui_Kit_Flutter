                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: value == index
                        ? LinearGradient(
                            colors: [
                              CustomAppColor.of(context).primary2,
                    ...
                    border: Border.all(
                      color: value == index ? CustomAppColor.of(context).primary : CustomAppColor.of(context).greyIndicator,
                      width: 0.5,
                    ),
                  ),
        ...
        return Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: CustomAppColor.of(context).bgCard, width: 1),
            ),
            child: Column(
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: getIt.get<LocalStorageService>().getBool(LocalStorageService.isLightTheme, optionalValue: true)
                          ? null
                          : LinearGradient(
                              colors: [
                                CustomAppColor.of(context).primary2,
