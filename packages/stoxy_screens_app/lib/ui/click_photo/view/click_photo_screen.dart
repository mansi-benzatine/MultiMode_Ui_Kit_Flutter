...
import 'package:stoxy_screens_app_package/utils/debug.dart';
    ...
    try {
      ...
      if (_cameras != null && _cameras!.isNotEmpty) {
        _cameraController = CameraController(
          widget.isSelfie ? _cameras![1] : _cameras![0],
                    ...
                    Positioned(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            CommonText(
                              text: widget.isSelfie ? "Your Selfie With Your Id Card" : Languages.of(context).txtPhotoIdCard,
