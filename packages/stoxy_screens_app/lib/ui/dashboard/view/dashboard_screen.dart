...
import 'package:stoxy_screens_app_package/ui/news/views/news_screen.dart';
...
class DashboardScreen extends StatefulWidget {
  ...
  static Route<void> route({int currentIndex = 0, bool isForLogoutDialog = false, bool isForDeleteAccount = false}) {
  ...
  const DashboardScreen({super.key, this.currentIndex = 0, this.isForLogoutDialog = false, this.isForDeleteAccount = false});
