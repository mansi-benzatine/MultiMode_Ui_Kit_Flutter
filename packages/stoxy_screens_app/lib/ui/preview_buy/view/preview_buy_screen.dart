...
class PreviewBuyScreen extends StatefulWidget {
  ...
  static Route<void> route({required WishListItemData data, bool isForDialog = false}) {
    return MaterialPageRoute(
      builder: (context) => PreviewBuyScreen(data: data, isForDialog: isForDialog),
    );
  }

  const PreviewBuyScreen({super.key, required this.data, this.isForDialog = false});
