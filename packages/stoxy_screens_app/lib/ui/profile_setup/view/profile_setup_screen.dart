...
import 'package:stoxy_screens_app_package/dialogs/alerts/congratulations_dialog.dart';
import 'package:stoxy_screens_app_package/localization/language/languages.dart';
import 'package:stoxy_screens_app_package/ui/profile_setup/pages/create_pin_page.dart';
import 'package:stoxy_screens_app_package/ui/profile_setup/pages/select_country_page.dart';
import 'package:stoxy_screens_app_package/ui/profile_setup/pages/select_gender_page.dart';
import 'package:stoxy_screens_app_package/ui/profile_setup/pages/selfie_id_page.dart';
import 'package:stoxy_screens_app_package/ui/profile_setup/pages/set_your_profile.dart';
import 'package:stoxy_screens_app_package/ui/profile_setup/pages/upload_national_id_page.dart';
...
class ProfileSetupScreen extends StatefulWidget {
  ...
  static Route<void> route({int currentIndex = 0, bool isForDialog = false}) {
    return MaterialPageRoute(
      builder: (_) => ProfileSetupScreen(currentIndex: currentIndex, isForDialog: isForDialog),
    );
  }
