...
import 'package:grokit_app/ui/on_boarding/view/on_boarding_screen.dart';
...
class GroKitApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _GroKitAppState? state = context.findAncestorStateOfType<_GroKitAppState>();
  ...
  const GroKitApp({super.key, this.externalThemeData});

  @override
  State<GroKitApp> createState() => _GroKitAppState();
}

class _GroKitAppState extends State<GroKitApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: GroKitApp.navigatorKey,
...
class GroKitAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const GroKitAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = GroKitApp.navigatorKey.currentState;
        ...
        child: GroKitApp(externalThemeData: themeData),
      ),
    );
  }
}
