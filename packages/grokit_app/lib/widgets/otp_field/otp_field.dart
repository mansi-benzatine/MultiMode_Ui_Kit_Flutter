...
class _OTPTextFieldState extends State<OTPTextField> {
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          isCollapsed: true,
          border: _getBorder(
            hasValue ? CustomAppColor.of(context).borderOtp : _otpFieldStyle.borderColor,
            hasValue: hasValue,
          ),
          focusedBorder: _getBorder(CustomAppColor.of(context).borderOtp, hasValue: hasValue),
          enabledBorder: _getBorder(
            hasValue ? CustomAppColor.of(context).borderOtp : _otpFieldStyle.enabledBorderColor,
            hasValue: hasValue,
          ),
  ...
  InputBorder _getBorder(Color color, {bool hasValue = false}) {
    double width = hasValue ? 1.0 : (widget.fieldStyle == FieldStyle.box ? 0.92 : 2.0);
