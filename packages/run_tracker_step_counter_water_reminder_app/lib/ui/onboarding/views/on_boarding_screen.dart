...
import 'package:run_tracker_step_counter_water_reminder_app/ui/fill_information/views/fill_information_screen.dart';
  ...
  void fillData() {
    onboardingItems = [
      ...
      OnboardingItem(
        ...
        title: "Step Counter",
        description: "This step counter app is very easy to use. Open it and start to walk, step counter app automatically records your steps.",
      ),
      OnboardingItem(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          // Background image
          Positioned.fill(child: Image.asset(onboardingItems[_currentIndex].image, fit: BoxFit.cover)),
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [Colors.transparent, Color(0xFF24232A), Color(0xFF24232A)],
                  stops: [0.4, 0.7, 1.0],
                ),
              ),
            ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(vertical: 20.setHeight, horizontal: 30.setWidth),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          GestureDetector(
                            onTap: _skip,
                            child: CommonText(text: "Skip", fontWeight: FontWeight.w500, fontSize: 18.setFontSize, textColor: Colors.grey),
                          ),
                          Row(
                            children: List.generate(onboardingItems.length, (dotIndex) {
                              return Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 4),
                                child: CircleAvatar(radius: 4, backgroundColor: _currentIndex == dotIndex ? Colors.white : Colors.white38),
                              );
                            }),
                          ),
                          GestureDetector(
                            onTap: _nextPage,
                            child: CommonText(
                              text: _currentIndex == onboardingItems.length - 1 ? "Done" : "Next",
