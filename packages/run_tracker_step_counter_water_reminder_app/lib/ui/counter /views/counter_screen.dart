...
import 'package:run_tracker_step_counter_water_reminder_app/ui/pause_run_tracker/views/pause_run_tracker_screen.dart';
  ...
  void _startCountdown() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (timer) {
      if (_currentIndex < countdownImages.length - 1) {
        ...
        Navigator.push(context, PauseRunTrackerScreen.route());
      }
    });
  }
