...
import 'package:run_tracker_step_counter_water_reminder_app/ui/onboarding/views/on_boarding_screen.dart';
...
class RunTrackerStepCounterWaterReminderApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _RunTrackerStepCounterWaterReminderAppState? state = context
        .findAncestorStateOfType<_RunTrackerStepCounterWaterReminderAppState>();
  ...
  const RunTrackerStepCounterWaterReminderApp({
    super.key,
    this.externalThemeData,
  });

  @override
  State<RunTrackerStepCounterWaterReminderApp> createState() =>
      _RunTrackerStepCounterWaterReminderAppState();
}

class _RunTrackerStepCounterWaterReminderAppState
    extends State<RunTrackerStepCounterWaterReminderApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return MaterialApp(
          ...
          navigatorKey: RunTrackerStepCounterWaterReminderApp.navigatorKey,
...
class RunTrackerStepCounterWaterReminderAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const RunTrackerStepCounterWaterReminderAppWrapper({
    super.key,
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator =
              RunTrackerStepCounterWaterReminderApp.navigatorKey.currentState;
        ...
        child: RunTrackerStepCounterWaterReminderApp(
