...
import 'package:run_tracker_step_counter_water_reminder_app/utils/service_locator.dart';
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Divider(color: CustomAppColor.of(context).white, height: 35.setHeight),
                      widgets,
                    ],
                  ),
                ),
