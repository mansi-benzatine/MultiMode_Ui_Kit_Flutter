...
class _OTPTextFieldState extends State<OTPTextField> {
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          counterText: "",
          contentPadding: EdgeInsets.symmetric(vertical: 15.setHeight, horizontal: 0),
          border: _getBorder(_pin[i].isNotEmpty ? CustomAppColor.of(context).primary : _otpFieldStyle.borderColor),
  ...
  InputBorder _getBorder(Color color) {
    return widget.fieldStyle == FieldStyle.box
        ? OutlineInputBorder(borderSide: BorderSide(color: color, width: 2.5))
