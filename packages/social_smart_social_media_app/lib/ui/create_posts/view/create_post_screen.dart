...
class _CreatePostScreenState extends State<CreatePostScreen> with TickerProviderStateMixin {
  ...
  Widget topIcons() {
    return Row(
      children: [
        IconButton(
          onPressed: () => Navigator.push(context, HomeScreen.route()),
          icon: const Icon(
            Icons.clear,
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 4), // Small spacing between icon & text
                    CommonText(
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            IconButton(
              onPressed: () => Navigator.push(context, CreatePostScreen.route()),
              icon: const Icon(
                Icons.clear,
                color: AppColor.white,
              ),
