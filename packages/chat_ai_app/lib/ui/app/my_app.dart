...
class ChatAiApp extends StatefulWidget {
  ...
  const ChatAiApp({super.key, this.externalThemeData});

  @override
  State<ChatAiApp> createState() => _ChatAiAppState();
}

class _ChatAiAppState extends State<ChatAiApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: ChatAiApp.navigatorKey,
...
class ChatAiAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const ChatAiAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = ChatAiApp.navigatorKey.currentState;
        ...
        child: ChatAiApp(externalThemeData: themeData),
      ),
    );
  }
}
