...
class _ChatScreenState extends State<ChatScreen> {
  final List<ChatMessage> messages = [
    ChatMessage(message: "Hello sir, where are you?", time: "09:31 am", isSentByMe: false),
    ChatMessage(message: "I am nearby jackson circle", time: "09:32 am", isSentByMe: true),
    ChatMessage(message: "Sorry sir, I am stuck in traffic.\nPlease give me a moment", time: "09:35 am", isSentByMe: false),
    ChatMessage(message: "Ok no problem,\nI am waiting", time: "09:33 am", isSentByMe: true),
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: IconButton(icon: Icon(Icons.arrow_back, color: CustomAppColor.of(context).icBlackWhite), onPressed: () {}),
        ),
        actions: [
          Icon(Icons.call, color: CustomAppColor.of(context).icBlackWhite),
