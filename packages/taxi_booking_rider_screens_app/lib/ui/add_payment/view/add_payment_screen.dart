...
class _AddPaymentScreenState extends State<AddPaymentScreen> implements TopBarClickListener {
  @override
  ...
  Widget _paymentOption(String logo, String text, VoidCallback onTap) {
    return IgnorePointer(
      ignoring: true,
      child: ListTile(
        contentPadding: EdgeInsets.symmetric(vertical: 6.setHeight, horizontal: 22.setWidth),
        leading: Image.asset(
          logo,
          width: 72.setWidth,
          height: 50.setHeight,
