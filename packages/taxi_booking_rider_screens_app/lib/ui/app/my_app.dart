...
import 'package:taxi_booking_rider_screens_app_package/ui/screens_list/view/screens_list_screen.dart';
...
class TaxiBookingRiderScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _TaxiBookingRiderScreensAppState? state = context.findAncestorStateOfType<_TaxiBookingRiderScreensAppState>();
  ...
  const TaxiBookingRiderScreensApp({super.key, this.externalThemeData});

  @override
  State<TaxiBookingRiderScreensApp> createState() => _TaxiBookingRiderScreensAppState();
}

class _TaxiBookingRiderScreensAppState extends State<TaxiBookingRiderScreensApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: TaxiBookingRiderScreensApp.navigatorKey,
...
class TaxiBookingRiderScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const TaxiBookingRiderScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = TaxiBookingRiderScreensApp.navigatorKey.currentState;
        ...
        child: TaxiBookingRiderScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
