...
import 'package:flowly_screens_app/ui/log_symptoms/datamodel/log_symptoms_data.dart';
...
import 'package:flowly_screens_app/utils/utils.dart';
import 'package:flowly_screens_app/widgets/bottom_sheet/log_symptoms_bs.dart';
import 'package:flowly_screens_app/widgets/bottom_sheet/log_symptoms_details_bg.dart';
...
class CalendarScreen extends StatefulWidget {
  final bool isShowLogBs;
  final bool isShowLogDetailsBs;

  static Route<void> route({bool isShowLogBs = false, bool isShowLogDetailsBs = false}) {
    return MaterialPageRoute(
      builder: (_) => CalendarScreen(
        isShowLogBs: isShowLogBs,
        isShowLogDetailsBs: isShowLogDetailsBs,
      ),
    );
  }

  const CalendarScreen({super.key, this.isShowLogBs = false, this.isShowLogDetailsBs = false});
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [LogSymptomsBs(date: selectedDate!)],
                      ),
                    ),
                  ],
                ),
                        ...
                        children: [
                          LogDetailsBottomSheet(
                            log: DailyLog(
                              ...
                              mood: [AppAssets.icClamEmoji, AppAssets.icTiredEmoji],
                              symptoms: [
                                AppAssets.icOverSleepSymptoms,
                                AppAssets.icCravingSymptoms,
                                AppAssets.icBackacheSymptoms,
                                AppAssets.icNauseaSymptoms,
                                AppAssets.icVaginalItchingSymptoms,
                              ],
                              menstrualFlow: [AppAssets.icHighMenstrualFlow],
                              pills: [
                                PillLog(
