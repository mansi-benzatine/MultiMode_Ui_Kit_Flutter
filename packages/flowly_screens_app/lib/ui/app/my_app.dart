import 'package:flowly_screens_app/ui/screens_list/view/screens_list_screen.dart';
...
class FlowlyScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _FlowlyScreensAppState? state = context.findAncestorStateOfType<_FlowlyScreensAppState>();
  ...
  const FlowlyScreensApp({super.key, this.externalThemeData});

  @override
  State<FlowlyScreensApp> createState() => _FlowlyScreensAppState();
}

class _FlowlyScreensAppState extends State<FlowlyScreensApp> {
  Locale? _locale;
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: ScreenUtilInit(
        ...
        builder: (_, __) {
          return MaterialApp(
              navigatorKey: FlowlyScreensApp.navigatorKey,
...
class FlowlyScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const FlowlyScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = FlowlyScreensApp.navigatorKey.currentState;
        ...
        child: FlowlyScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
