...
class BookmarkScreen extends StatefulWidget {
  ...
  static Route<void> route({bool isForEmptyScreen = false}) {
    return MaterialPageRoute(
      builder: (_) => BookmarkScreen(isForEmptyScreen: isForEmptyScreen),
    );
  }

  const BookmarkScreen({super.key, this.isForEmptyScreen = false});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: widget.isForEmptyScreen == false
