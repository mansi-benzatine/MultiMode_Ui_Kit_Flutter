      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            filled: true,
            fillColor: widget.fillColor ?? CustomAppColor.of(context).bgScreen,
            ...
            border: OutlineInputBorder(
              ...
              borderSide: BorderSide(width: 1, color: CustomAppColor.of(context).unfilledBorderTextFormField),
            ),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(color: CustomAppColor.of(context).txtBlack.withOpacityPercent(0.08)),
            ),
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            filled: true,
            fillColor: widget.fillColor ?? CustomAppColor.of(context).textFormFieldBg,
            hintText: widget.hintText,
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(color: !(isFocused || isEmpty) ? CustomAppColor.of(context).transparent : CustomAppColor.of(context).borderTextFormField, width: 1),
            ),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.radius),
              borderSide: BorderSide(color: widget.borderColor ?? CustomAppColor.of(context).borderTextFormField, width: 1),
