...
import 'package:mivi_app/ui/onboarding/view/onboarding_screen.dart';
...
class MiviApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _MiviAppState? state = context.findAncestorStateOfType<_MiviAppState>();
  ...
  const MiviApp({super.key, this.externalThemeData});

  @override
  State<MiviApp> createState() => _MiviAppState();
}

class _MiviAppState extends State<MiviApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: MiviApp.navigatorKey,
...
class MiviAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const MiviAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = MiviApp.navigatorKey.currentState;
        ...
        child: MiviApp(externalThemeData: themeData),
      ),
    );
  }
}
