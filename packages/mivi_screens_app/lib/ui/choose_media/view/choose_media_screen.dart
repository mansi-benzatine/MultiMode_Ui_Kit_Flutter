...
import 'package:mivi_screens_app/ui/edit_video/view/edit_video_screen.dart';
...
class ChooseMediaScreen extends StatefulWidget {
  ...
  static Route<void> route({int currentIndex = 0}) {
    return MaterialPageRoute(builder: (_) => ChooseMediaScreen(currentIndex: currentIndex));
  }

  const ChooseMediaScreen({super.key, this.currentIndex = 0});
                  ...
                  Padding(
                    ...
                    child: IgnorePointer(
                      ...
                      child: CommonButton(
                        ...
                        onTap: () {
                          Navigator.push(context, EditVideoScreen.route(imageList: selectedList));
                        },
                      ),
                    ),
                  )
