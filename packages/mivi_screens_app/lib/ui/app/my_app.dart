...
import 'package:mivi_screens_app/ui/screens_list/view/screens_list_screen.dart';
...
class MiviScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _MiviScreensAppState? state = context.findAncestorStateOfType<_MiviScreensAppState>();
  ...
  const MiviScreensApp({super.key, this.externalThemeData});

  @override
  State<MiviScreensApp> createState() => _MiviScreensAppState();
}

class _MiviScreensAppState extends State<MiviScreensApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: MiviScreensApp.navigatorKey,
...
class MiviScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const MiviScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = MiviScreensApp.navigatorKey.currentState;
        ...
        child: MiviScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
