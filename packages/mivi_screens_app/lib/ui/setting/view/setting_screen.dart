...
import 'package:mivi_screens_app/ui/app/my_app.dart';
...
import 'package:mivi_screens_app/ui/setting/datamodel/setting_data.dart';
...
import 'package:mivi_screens_app/widgets/alert_dialog/logout_aleart_dialog.dart';
...
class SettingScreen extends StatefulWidget {
  ...
  static Route<void> route({bool isShowLogoutAlert = false}) {
    return MaterialPageRoute(
      builder: (_) => SettingScreen(isShowLogoutAlert: isShowLogoutAlert),
    );
  }

  const SettingScreen({super.key, this.isShowLogoutAlert = false});
                      ...
                      return IgnorePointer(
                        ...
                        child: FlutterSwitch(
                          ...
                          onToggle: (bool newValue) {
                            ...
                            MiviScreensApp.changeTheme(context, newTheme);
                          },
