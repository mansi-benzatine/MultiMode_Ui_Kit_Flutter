...
import 'package:food_delivery_screens_app_package/ui/general_issues/datamodels/general_issues_data.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                AnimatedCrossFade(
                  ...
                  secondChild: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 24.setWidth, vertical: 8.setHeight),
                    child: CommonText(
                      text: issue.solution,
                      fontSize: 16.setFontSize,
                      textColor: CustomAppColor.of(context).txtGrey,
