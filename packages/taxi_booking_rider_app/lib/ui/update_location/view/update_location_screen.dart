...
class _UpdateLocationScreenState extends State<UpdateLocationScreen> {
  ...
  final TextEditingController pickUpController =
      TextEditingController(text: "1397 Walnut Street, Jackson");
  final TextEditingController dropOffController =
      TextEditingController(text: "345 Hardesty Street, 368972");
            ...
            children: [
              ListView.builder(
                padding: EdgeInsets.only(
                    top: 170.setHeight, left: 22.setWidth, right: 22.setWidth),
              ...
              Positioned(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(
                      vertical: 22.setHeight, horizontal: 22.setWidth),
                  child: CommonButton(
                      onTap: () => Navigator.pop(context),
