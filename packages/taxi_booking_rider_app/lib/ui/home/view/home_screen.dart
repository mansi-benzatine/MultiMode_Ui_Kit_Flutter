...
import 'package:taxi_booking_rider_app_package/ui/cancel_ride/view/cancel_ride_screen.dart';
import 'package:taxi_booking_rider_app_package/ui/create_trip/view/create_trip_screen.dart';
import 'package:taxi_booking_rider_app_package/ui/edit_account/view/edit_account_screen.dart';
import 'package:taxi_booking_rider_app_package/ui/invite_friends/view/invite_friends_screen.dart';
import 'package:taxi_booking_rider_app_package/ui/notifications/view/notification_screen.dart';
import 'package:taxi_booking_rider_app_package/ui/settings/view/settings_screen.dart';
import 'package:taxi_booking_rider_app_package/ui/wallet/view/wallet_screen.dart';
import 'package:taxi_booking_rider_app_package/ui/your_trips/view/your_trips_screen.dart';
...
import 'package:taxi_booking_rider_app_package/widgets/text_field/text_form_field.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    if (_isFromRideBooked) {
      _timer = Timer(
        const Duration(seconds: 5),
        () {
          if (mounted && _isFromRideBooked) {
            setState(() {
