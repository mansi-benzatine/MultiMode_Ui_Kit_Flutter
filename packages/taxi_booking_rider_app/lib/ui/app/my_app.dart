...
class TaxiBookingRiderApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _TaxiBookingRiderAppState? state =
        context.findAncestorStateOfType<_TaxiBookingRiderAppState>();
  ...
  const TaxiBookingRiderApp({super.key, this.externalThemeData});

  @override
  State<TaxiBookingRiderApp> createState() => _TaxiBookingRiderAppState();
}

class _TaxiBookingRiderAppState extends State<TaxiBookingRiderApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: TaxiBookingRiderApp.navigatorKey,
...
class TaxiBookingRiderAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const TaxiBookingRiderAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = TaxiBookingRiderApp.navigatorKey.currentState;
        ...
        child: TaxiBookingRiderApp(externalThemeData: themeData),
      ),
    );
  }
}
