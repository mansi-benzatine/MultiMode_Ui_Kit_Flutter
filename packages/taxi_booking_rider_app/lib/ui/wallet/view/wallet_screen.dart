...
import 'package:taxi_booking_rider_app_package/ui/add_payment/view/add_payment_screen.dart';
import 'package:taxi_booking_rider_app_package/ui/add_promo_code/view/add_promo_code_screen.dart';
import 'package:taxi_booking_rider_app_package/ui/add_vouncher_code/view/add_voucher_screen.dart';
    ...
    return InkWell(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(
            horizontal: 20.setWidth, vertical: 18.setHeight),
        child: Column(
              ...
              children: [
                ...
                if (trailing != null)
                  Expanded(
                    child: Padding(
                      padding:
                          EdgeInsets.only(left: 8.setWidth, top: 2.setHeight),
                      child: trailing,
                    ),
                  ),
              ],
