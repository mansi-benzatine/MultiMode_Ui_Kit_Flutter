...
import 'package:furniture_screens_app_package/utils/utils.dart';
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: widget.prefixIcon.isNotEmpty
                ? InkWell(
                    ...
                    child: Padding(
                      padding: EdgeInsets.only(left: 20.setWidth, right: 14.setWidth),
                      child: Image.asset(
                        widget.prefixIcon,
                        height: 20.setHeight,
                        width: 20.setHeight,
                        color: (isFocused || isEmpty) ? CustomAppColor.of(context).txtBlack : widget.prefixIconColor,
                        gaplessPlayback: true,
                      ),
                    ),
                  )
            ...
            suffixIcon: InkWell(
              ...
              child: UnconstrainedBox(
                child: Image.asset(
                  ...
                  height: 20.setHeight,
                  width: 20.setHeight,
                  color: (isFocused || isEmpty) ? CustomAppColor.of(context).txtBlack : widget.suffixIconColor,
                  gaplessPlayback: true,
                ),
              ),
            ),
