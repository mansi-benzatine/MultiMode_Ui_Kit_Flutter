...
import 'package:furniture_screens_app_package/ui/payment/view/payment_screen.dart';
...
class CheckoutScreen extends StatefulWidget {
  ...
  static Route<void> route({bool isForDeleteDialog = false}) {
    return MaterialPageRoute(builder: (_) => CheckoutScreen(isForDeleteDialog: isForDeleteDialog));
  }

  const CheckoutScreen({super.key, this.isForDeleteDialog = false});
    ...
    if (widget.isForDeleteDialog) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        showModalBottomSheet(
          ...
          builder: (_) => RemoveFromCartBottomSheet(
            item: ProductItem(
              name: "Night Lamp ",
              description: "Luxury Lamp",
              image: AppAssets.imgDummyLamp,
