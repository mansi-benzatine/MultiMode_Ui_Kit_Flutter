...
import 'package:furniture_screens_app_package/ui/faq_details/views/faq_details_screen.dart';
...
class HelpCenterScreen extends StatefulWidget {
  ...
  const HelpCenterScreen({super.key, this.currentTabIndex = 0});

  static Route<dynamic> route({int currentTabIndex = 0}) {
    return MaterialPageRoute(
      builder: (context) => HelpCenterScreen(currentTabIndex: currentTabIndex),
    );
  }
...
class _HelpCenterScreenState extends State<HelpCenterScreen> with TickerProviderStateMixin implements TopBarClickListener {
  ...
  void initState() {
    super.initState();
    _tabController = TabController(length: 2, vsync: this, initialIndex: widget.currentTabIndex);
