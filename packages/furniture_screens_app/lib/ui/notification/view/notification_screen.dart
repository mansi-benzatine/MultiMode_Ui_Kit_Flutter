...
class NotificationScreen extends StatefulWidget {
  final bool isForEmptyNotificationScreen;
  static Route<void> route({bool isForEmptyNotificationScreen = false}) {
    return MaterialPageRoute(builder: (_) => NotificationScreen(isForEmptyNotificationScreen: isForEmptyNotificationScreen));
  }

  const NotificationScreen({super.key, this.isForEmptyNotificationScreen = false});
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            if (notifications.isEmpty || widget.isForEmptyNotificationScreen)
              Center(
                child: Column(
            ...
            if (!widget.isForEmptyNotificationScreen)
              Expanded(
                child: ListView(
