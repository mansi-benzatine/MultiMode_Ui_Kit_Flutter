...
class MyFavouritesScreen extends StatefulWidget {
  ...
  static Route<void> route({bool isForEmptyFavourite = false}) {
    return MaterialPageRoute(builder: (_) => MyFavouritesScreen(isForEmptyFavourite: isForEmptyFavourite));
  }

  const MyFavouritesScreen({super.key, this.isForEmptyFavourite = false});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          if (products.isEmpty || widget.isForEmptyFavourite)
            Expanded(
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Image.asset(AppAssets.imgEmptyCategoryDetails, height: 120.setHeight),
