import 'package:cinemix_app/ui/who_is_watching/view/who_is_watching_screen.dart';
...
class ProfileSetupSuccessDialog extends StatelessWidget {
  ...
  const ProfileSetupSuccessDialog({super.key, required this.parentContext});
            ...
            Padding(
              ...
              child: CommonButton(
                ...
                onTap: () {
                  ...
                  Navigator.push(parentContext, WhoIsWatchingScreen.route());
                },
                height: 45.setHeight,
              ),
            ),
