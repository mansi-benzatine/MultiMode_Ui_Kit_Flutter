import 'package:cinemix_app/ui/onboarding/view/onboarding_screen.dart';
...
class CinemixApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _CinemixAppState? state = context.findAncestorStateOfType<_CinemixAppState>();
  ...
  const CinemixApp({super.key, this.externalThemeData});

  @override
  State<CinemixApp> createState() => _CinemixAppState();
}

class _CinemixAppState extends State<CinemixApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
              navigatorKey: CinemixApp.navigatorKey,
...
class CinemixAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const CinemixAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = CinemixApp.navigatorKey.currentState;
        ...
        child: CinemixApp(externalThemeData: themeData),
      ),
    );
  }
}
