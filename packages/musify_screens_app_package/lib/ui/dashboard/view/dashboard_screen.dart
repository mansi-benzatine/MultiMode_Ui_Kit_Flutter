...
import 'package:musify_screens_app_package/ui/home/view/home_screen.dart';
import 'package:musify_screens_app_package/ui/my_music/view/my_music_screen.dart';
...
class DashboardScreen extends StatefulWidget {
  ...
  final bool isShowPlayingMusic;
  final int currentIndexForHomeScreen;
  final int currentIndexForMyMusicScreen;
  final bool isShowCreatePlaylist;
  final int currentIndexForFavouriteScreen;
  final int subCurrentIndexForFavouriteScreen;
  final bool isForDeleteDialog;
  final bool isForLogoutDialog;

  static Route<void> route({
    int currentIndex = 0,
    bool isShowPlayingMusic = false,
    int currentIndexForHomeScreen = 0,
    int currentIndexForMyMusicScreen = 0,
    bool isShowCreatePlaylistBs = false,
    int currentIndexForFavouriteScreen = 0,
    int subCurrentIndexForFavouriteScreen = 0,
    bool isForLogoutDialog = false,
    bool isForDeleteDialog = false,
  }) {
    return MaterialPageRoute(
      builder: (_) => DashboardScreen(
        currentIndex: currentIndex,
        isShowPlayingMusic: isShowPlayingMusic,
        currentIndexForHomeScreen: currentIndexForHomeScreen,
        currentIndexForMyMusicScreen: currentIndexForMyMusicScreen,
        isShowCreatePlaylist: isShowCreatePlaylistBs,
        currentIndexForFavouriteScreen: currentIndexForFavouriteScreen,
        subCurrentIndexForFavouriteScreen: subCurrentIndexForFavouriteScreen,
  ...
  const DashboardScreen({
    super.key,
    this.currentIndex = 0,
    this.isShowPlayingMusic = false,
    this.currentIndexForHomeScreen = 0,
    this.currentIndexForMyMusicScreen = 0,
    this.isShowCreatePlaylist = false,
    this.currentIndexForFavouriteScreen = 0,
    this.subCurrentIndexForFavouriteScreen = 0,
    this.isForDeleteDialog = false,
    this.isForLogoutDialog = false,
  });
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    super.initState();
    _pages = [
      HomeScreen(currentIndex: widget.currentIndexForHomeScreen),
      MyMusicScreen(
        currentIndex: widget.currentIndexForMyMusicScreen,
        isForCreatePlaylistBs: widget.isShowCreatePlaylist,
      ),
      FavouriteScreen(
        currentIndex: widget.currentIndexForFavouriteScreen,
        subCurrentIndex: widget.subCurrentIndexForFavouriteScreen,
      ),
      ProfileScreen(
        isForLogoutDialog: widget.isForLogoutDialog,
        isForDeleteDialog: widget.isForDeleteDialog,
      ),
    ];
        ...
        children: [
          ValueListenableBuilder<MusicItemData?>(
              ...
              builder: (context, value, child) {
                ...
                return (value != null || widget.isShowPlayingMusic)
                    ? InkWell(
                        onTap: () {
                          ...
                          child: Row(
                            children: [
                              ...
                              ClipRRect(
                                ...
                                child: Image.asset(
                                  MusifyScreensApp.playingMusicNotifier.value?.image ?? AppAssets.imgMusic1,
                                  height: 40.setHeight,
                                  fit: BoxFit.contain,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    CommonText(
                                      text: MusifyScreensApp.playingMusicNotifier.value?.name ?? 'Baby',
                                      fontSize: 14.setFontSize,
                                      fontWeight: FontWeight.w600,
                                      textColor: CustomAppColor.of(context).white,
                                    ),
                                    CommonText(
                                      text: MusifyScreensApp.playingMusicNotifier.value?.singer ?? 'Justin Bieber',
