...
import 'package:musify_screens_app_package/dialogs/bottom_sheet/music_more_option_bottom_sheet.dart';
import 'package:musify_screens_app_package/interfaces/top_bar_click_listener.dart';
...
class PlayNowScreen extends StatefulWidget {
  ...
  final bool isShowMoreBs;

  static Route<void> route({MusicItemData? musicItem, bool isShowMoreBs = false}) {
    return MaterialPageRoute(builder: (_) => PlayNowScreen(musicItem: musicItem, isShowMoreBs: isShowMoreBs));
  }

  const PlayNowScreen({super.key, this.musicItem, this.isShowMoreBs = false});
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  IgnorePointer(
                                    ignoring: true,
                                    child: _buildActionButton(AppAssets.icMore, () {
                                      showModalBottomSheet(
                                        context: context,
                                        isScrollControlled: true,
                                        builder: (context) => MusicMoreOptionBottomSheet(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        setState(() {
                                          isPlaying = !isPlaying;
                                          if (isPlaying) {
                                            MusifyScreensApp.playingMusicNotifier.value = widget.musicItem;
                                          } else {
