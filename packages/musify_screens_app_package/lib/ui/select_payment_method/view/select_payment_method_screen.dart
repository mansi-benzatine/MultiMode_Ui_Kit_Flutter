...
import 'package:musify_screens_app_package/ui/premium_plan_list/view/premium_plan_list_screen.dart';
...
class SelectPaymentMethodScreen extends StatefulWidget {
  ...
  static Route<void> route({required PremiumPlanData plan}) {
    return MaterialPageRoute(builder: (_) => SelectPaymentMethodScreen(plan: plan));
  }
