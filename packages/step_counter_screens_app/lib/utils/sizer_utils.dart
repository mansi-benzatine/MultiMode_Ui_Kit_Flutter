...
extension SizeExtension on num {
  ...
  static double setFontSizeCustom(double size) {
    ...
    final context = StepCounterScreensApp.navigatorKey.currentContext!;
...
// Add a helper method to detect foldable phones
  ...
  double get buttonHeight => ScreenUtil().setHeight(40);

  double get bottomPadding => (MediaQuery.of(StepCounterScreensApp.navigatorKey.currentContext!).padding.bottom + 10).setHeight;
  double get topPadding => (MediaQuery.of(StepCounterScreensApp.navigatorKey.currentContext!).padding.top + 10).setHeight;
}
