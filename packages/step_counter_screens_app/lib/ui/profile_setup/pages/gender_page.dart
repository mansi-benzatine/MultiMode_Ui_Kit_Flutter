                ...
                return InkWell(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: (value == Languages.of(context).txtMale) ? CustomAppColor.of(context).primary : CustomAppColor.of(context).borderColorDark,
                        width: 1,
                      ),
                    ),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          width: 38.setHeight,
                          decoration: BoxDecoration(
                            color: (value == Languages.of(context).txtMale) ? CustomAppColor.of(context).primary : CustomAppColor.of(context).lightBlueColor,
                ...
                return InkWell(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: (value == Languages.of(context).txtFemale) ? CustomAppColor.of(context).primary : CustomAppColor.of(context).borderColorDark,
                        width: 1,
                      ),
                    ),
                    padding: EdgeInsets.symmetric(horizontal: 12.setWidth, vertical: 8.setHeight),
                    child: Row(
                      children: [
                        Container(
                          ...
                          width: 38.setHeight,
                          decoration: BoxDecoration(
                            color: (value == Languages.of(context).txtFemale) ? CustomAppColor.of(context).primary : CustomAppColor.of(context).lightBlueColor,
                            borderRadius: BorderRadius.circular(1000),
                            border: Border.all(
                              color: (value == Languages.of(context).txtFemale) ? CustomAppColor.of(context).primary : CustomAppColor.of(context).lightBlueColor,
                              width: 1,
