...
import 'package:step_counter_screens_app_package/dialogs/bottom_sheet/set_bedtime_bottom_sheet_dialog.dart';
...
class SetSleepTargetScreen extends StatefulWidget {
  final bool isShowSetTimeBs;
  final bool isForBedTime;

  const SetSleepTargetScreen({super.key, this.isForBedTime = false, this.isShowSetTimeBs = false});
