...
import 'package:step_counter_screens_app_package/ui/water_report/pages/water_result_screen.dart';
...
import '../pages/water_all_records_screen.dart';
...
class WaterReportScreen extends StatefulWidget {
  ...
  const WaterReportScreen({super.key, this.isForEmptyView = false, this.periodName = "Day"});

  static Route<void> route() {
    return MaterialPageRoute<void>(builder: (context) => const WaterReportScreen());
  }
...
class _WaterReportScreenState extends State<WaterReportScreen> implements TopBarClickListener {
  ...
  final List<WeekChartData> weekChartData = [
    WeekChartData("Mon", 0, 15),
    WeekChartData("Tue", 1, 35),
    WeekChartData("Wed", 2, 58),
    WeekChartData("Thu", 3, 60),
    WeekChartData("Fri", 4, 70),
    WeekChartData("Sat", 5, 15),
    WeekChartData("Sun", 6, 85),
  ];
        ...
        return IgnorePointer(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: CustomAppColor.of(context).bgContainerBorderColorWater,
              ...
              children: [
                Expanded(
                  child: InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: value == "Day" ? CustomAppColor.of(context).colorWater : CustomAppColor.of(context).transparent,
                        borderRadius: BorderRadius.circular(1000),
                        border: Border.all(color: value == "Day" ? CustomAppColor.of(context).colorWater : CustomAppColor.of(context).transparent),
                      ),
                      ...
                      child: CommonText(
                        ...
                        textColor: value == "Day" ? CustomAppColor.of(context).white : CustomAppColor.of(context).colorWater,
                      ),
                    ),
                  ),
                ),
                Expanded(
                  child: InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: value == "Week" ? CustomAppColor.of(context).colorWater : CustomAppColor.of(context).transparent,
                        borderRadius: BorderRadius.circular(1000),
                        border: Border.all(color: value == "Week" ? CustomAppColor.of(context).colorWater : CustomAppColor.of(context).transparent),
                      ),
                      alignment: Alignment.center,
                      child: CommonText(
                        ...
                        fontSize: 16.setFontSize,
                        fontWeight: FontWeight.w500,
                        textColor: value == "Week" ? CustomAppColor.of(context).white : CustomAppColor.of(context).colorWater,
                      ),
                    ),
                  ),
                ),
                Expanded(
                  child: InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: value == "Month" ? CustomAppColor.of(context).colorWater : CustomAppColor.of(context).transparent,
                        borderRadius: BorderRadius.circular(1000),
                        border: Border.all(color: value == "Month" ? CustomAppColor.of(context).colorWater : CustomAppColor.of(context).transparent),
                      ),
                      alignment: Alignment.center,
                      child: CommonText(
                        ...
                        fontSize: 16.setFontSize,
                        fontWeight: FontWeight.w500,
                        textColor: value == "Month" ? CustomAppColor.of(context).white : CustomAppColor.of(context).colorWater,
                      ),
                    ),
                  ),
                ),
              ...
              series: <CartesianSeries<DayChartData, double>>[
                ColumnSeries<DayChartData, double>(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      CustomAppColor.of(context).colorWater,
                      CustomAppColor.of(context).colorWater.withValues(alpha: 0.0),
                    ],
      ...
      itemBuilder: (context, index) {
        if (index == dayHistoryList.length) {
          return IgnorePointer(
            ignoring: true,
            child: InkWell(
              onTap: () => Navigator.push(context, WaterAllRecordsScreen.route()),
              child: Container(
        ...
        return IgnorePointer(
          ignoring: true,
          child: InkWell(
            onTap: () => Navigator.push(context, WaterResultScreen.route()),
            child: Container(
              margin: EdgeInsets.only(bottom: 12.setHeight),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Image.asset(AppAssets.imgWaterGlasses, width: 18.setWidth, height: 18.setHeight),
                      SizedBox(width: 3.setWidth),
                      Expanded(
                        child: CommonText(
                          text: "${item.duration} Glasses",
                          fontSize: 12.setFontSize,
                          fontWeight: FontWeight.w500,
                          textAlign: TextAlign.start,
  ...
  _monthChartView() {
    ...
    BoxDecoration defaultDecoration = BoxDecoration(
      color: CustomAppColor.of(context).bgContainerWhiteAndBlack,
      border: Border.all(color: CustomAppColor.of(context).bgContainerBlackAndWaterColor, width: 3),
    ...
    return Column(
      children: [
        ...
        CommonText(
          ...
          fontSize: 16.setFontSize,
          fontWeight: FontWeight.w600,
          textColor: CustomAppColor.of(context).colorWater,
