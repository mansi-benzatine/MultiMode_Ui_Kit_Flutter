...
import 'package:step_counter_screens_app_package/dialogs/bottom_sheet/first_day_of_week_bottom_sheet_dialog.dart';
import 'package:step_counter_screens_app_package/dialogs/bottom_sheet/gender_bottom_sheet_dialog.dart';
import 'package:step_counter_screens_app_package/dialogs/bottom_sheet/height_bottom_sheet_dialog.dart';
import 'package:step_counter_screens_app_package/dialogs/bottom_sheet/step_goal_bottom_sheet_dialog.dart';
import 'package:step_counter_screens_app_package/dialogs/bottom_sheet/step_length_bottom_sheet_dialog.dart';
...
class _SettingScreenState extends State<SettingScreen> {
  ...
  void initState() {
    ...
    if (widget.setCurrentBs == 0) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        Utils.showBottomSheetDialog(
          ...
          isScrollControlled: false,
          isDismissible: false,
          title: Languages.of(context).txtHeigh,
          widgets: HeightBottomSheetDialog(
            onSave: () {},
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        Utils.showBottomSheetDialog(
          ...
          widgets: BedTimeBottomSheetDialog(
            onSave: () {},
            isSelectedBedTimeSchedule: widget.isSelectedBedTimeSchedule,
            isBedTime: widget.isSelectedBedTimeSchedule,
          ),
        ).whenComplete(() {
          if (_isBottomSheetOpen) {
            setState(() {
    ...
    } else if (widget.setCurrentBs == 10) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        setState(() {
          _isBottomSheetOpen = true;
        });
