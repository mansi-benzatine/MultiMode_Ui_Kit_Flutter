...
import 'package:step_counter_screens_app_package/ui/step_report/pages/step_result_screen.dart';
import 'package:step_counter_screens_app_package/ui/step_report/pages/steps_all_records_screen.dart';
...
import '../datamodel/step_report_data.dart';
...
class StepReportScreen extends StatefulWidget {
  ...
  const StepReportScreen({super.key, this.periodName = "Day", this.isForEmptyView = false});

  static Route<void> route() {
    return MaterialPageRoute<void>(builder: (context) => const StepReportScreen());
  }
...
class _StepReportScreenState extends State<StepReportScreen> implements TopBarClickListener {
  final ValueNotifier<String> periodName = ValueNotifier<String>("Day");

  // Sample data for day chart - representing hourly step counts
  ...
  // Sample data for week chart - representing hourly step counts
        ...
        return IgnorePointer(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: CustomAppColor.of(context).bgContainerBorderColorSteps,
                width: 0.2,
              ),
            ),
              ...
              children: [
                Expanded(
                  child: InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: value == "Day" ? CustomAppColor.of(context).colorSteps : CustomAppColor.of(context).transparent,
                        borderRadius: BorderRadius.circular(1000),
                        border: Border.all(color: value == "Day" ? CustomAppColor.of(context).colorSteps : CustomAppColor.of(context).transparent),
                      ),
                      ...
                      child: CommonText(
                        ...
                        textColor: value == "Day" ? CustomAppColor.of(context).white : CustomAppColor.of(context).colorSteps,
                      ),
                    ),
                  ),
                ),
                Expanded(
                  child: InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: value == "Week" ? CustomAppColor.of(context).colorSteps : CustomAppColor.of(context).transparent,
                        borderRadius: BorderRadius.circular(1000),
                        border: Border.all(color: value == "Week" ? CustomAppColor.of(context).colorSteps : CustomAppColor.of(context).transparent),
                      ),
                      alignment: Alignment.center,
                      child: CommonText(
                        ...
                        fontSize: 16.setFontSize,
                        fontWeight: FontWeight.w500,
                        textColor: value == "Week" ? CustomAppColor.of(context).white : CustomAppColor.of(context).colorSteps,
                      ),
                    ),
                  ),
                ),
                Expanded(
                  child: InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: value == "Month" ? CustomAppColor.of(context).colorSteps : CustomAppColor.of(context).transparent,
                        borderRadius: BorderRadius.circular(1000),
                        border: Border.all(color: value == "Month" ? CustomAppColor.of(context).colorSteps : CustomAppColor.of(context).transparent),
                      ),
                      alignment: Alignment.center,
                      child: CommonText(
                        ...
                        fontSize: 16.setFontSize,
                        fontWeight: FontWeight.w500,
                        textColor: value == "Month" ? CustomAppColor.of(context).white : CustomAppColor.of(context).colorSteps,
                      ),
                    ),
                  ),
                ),
              ...
              series: <CartesianSeries<DayChartData, double>>[
                ColumnSeries<DayChartData, double>(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      CustomAppColor.of(context).colorSteps,
                      CustomAppColor.of(context).colorSteps.withValues(alpha: 0.0),
                    ],
      ...
      itemBuilder: (context, index) {
        if (index == dayHistoryList.length) {
          return IgnorePointer(
            ignoring: true,
            child: InkWell(
              onTap: () => Navigator.push(context, StepsAllRecordsScreen.route()),
              child: Container(
        ...
        return IgnorePointer(
          ignoring: true,
          child: InkWell(
            onTap: () => Navigator.push(context, StepResultScreen.route()),
            child: Container(
              margin: EdgeInsets.only(bottom: 12.setHeight),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Image.asset(AppAssets.icPersonMove, width: 22.setWidth, height: 22.setHeight),
            ...
            child: InkWell(
              ...
              child: Column(
                children: [
                  ...
                  if (index != weekHistoryList.length - 1)
                    Divider(
                      height: 10.setHeight,
                      color: CustomAppColor.of(context).bgContainerColorSteps,
                      thickness: 1.5,
  ...
  _monthChartView() {
    ...
    BoxDecoration defaultDecoration = BoxDecoration(
      color: CustomAppColor.of(context).bgContainerWhiteAndBlack,
      border: Border.all(color: CustomAppColor.of(context).bgContainerBlackAndStepColor, width: 3),
