...
class CaloriesResultScreen extends StatefulWidget {
  ...
  static Route<void> route() {
    return MaterialPageRoute<void>(builder: (context) => const CaloriesResultScreen());
  }
...
class _CaloriesResultScreenState extends State<CaloriesResultScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Image.asset(AppAssets.imgBgCalorieResult),
          Positioned(
            top: 120.setHeight,
            ...
            child: BackdropFilter(
              filter: ImageFilter.blur(sigmaX: 0.0, sigmaY: 2.0),
              child: Container(
