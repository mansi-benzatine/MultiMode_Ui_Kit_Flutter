...
class DrinkWaterReminder extends StatefulWidget {
  final bool isShownSetIntervalBs;
  static Route<void> route({bool isShownSetIntervalBs = false}) {
    return MaterialPageRoute(builder: (_) => DrinkWaterReminder(isShownSetIntervalBs: isShownSetIntervalBs));
  }

  const DrinkWaterReminder({super.key, this.isShownSetIntervalBs = false});

  @override
  State<DrinkWaterReminder> createState() => _DrinkWaterReminderState();
}

class _DrinkWaterReminderState extends State<DrinkWaterReminder> implements TopBarClickListener {
  ...
  void showSetIntervalBS() {
    final List<String> volumeOptions = ["Every 0.5 hours", "Every 1 hours", "Every 1.5 hours", "Every 2 hours"];
    int selectedIndex = 0;
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        CommonText(text: Languages.of(context).txtSetInterval, fontSize: 24.setFontSize, fontWeight: FontWeight.bold),
                        IgnorePointer(
                          ignoring: true,
  ...
  void initState() {
    ...
    if (widget.isShownSetIntervalBs) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          TopBar(this, isShowBack: true, simpleTitle: Languages.of(context).txtDrinkWaterReminder, isShowSimpleTitle: true),
          Expanded(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      CommonText(text: Languages.of(context).txtNotifications, fontSize: 18.setFontSize),
                  ...
                  CommonText(text: Languages.of(context).txtSchedule, fontSize: 14.setFontSize, textColor: CustomAppColor.of(context).txtGrey),
                  ListTile(
                    minTileHeight: 1.setHeight,
                    contentPadding: EdgeInsets.zero,
                    title: CommonText(text: Languages.of(context).txtStart, textAlign: TextAlign.start, fontSize: 18.setFontSize),
                    trailing: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                  ...
                  ListTile(
                    minTileHeight: 1.setHeight,
                    contentPadding: EdgeInsets.zero,
                    title: CommonText(text: Languages.of(context).txtEnd, textAlign: TextAlign.start, fontSize: 18.setFontSize),
                    trailing: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                    ...
                    onTap: () async {
                      TimeOfDay? time = await showTimePicker(context: context, initialTime: endTime);
                      if (time != null) {
                  ...
                  ListTile(
                    minTileHeight: 1.setHeight,
                    contentPadding: EdgeInsets.zero,
                    title: CommonText(text: Languages.of(context).txtInterval, textAlign: TextAlign.start, fontSize: 18.setFontSize),
                    trailing: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        CommonText(text: "Every $interval hour${interval == 1 ? '' : 's'}"),
                        Icon(Icons.arrow_drop_down_outlined),
                      ],
                    ),
                  ),
                  Divider(),
                  SizedBox(height: 10.setHeight),
                  CommonText(text: Languages.of(context).txtMessage, textColor: CustomAppColor(context).txtGrey),
                  SizedBox(height: 10.setHeight),

                  CommonText(text: Languages.of(context).txtItIsTimeToDrinkWater, fontWeight: FontWeight.bold, fontSize: 16.setFontSize),
                ],
              ),
            ),
          ),
