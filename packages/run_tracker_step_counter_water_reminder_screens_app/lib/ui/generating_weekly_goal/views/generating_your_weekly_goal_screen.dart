...
import 'package:run_tracker_step_counter_water_reminder_screens_app/ui/weekly_goal/views/weekly_goal_screen.dart';
...
class GeneratingYourWeeklyGoalScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(
      builder: (_) => const GeneratingYourWeeklyGoalScreen(),
    );
  }
  ...
  @override
  State<GeneratingYourWeeklyGoalScreen> createState() =>
      _GeneratingYourWeeklyGoalScreenState();
}

class _GeneratingYourWeeklyGoalScreenState
    extends State<GeneratingYourWeeklyGoalScreen>
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            CommonText(
              text: "Generating Your Weekly Goal",
