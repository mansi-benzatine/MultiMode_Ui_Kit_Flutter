...
import 'package:run_tracker_step_counter_water_reminder_screens_app/ui/app/my_app.dart';
...
extension SizeExtension on num {
  ...
  static double setFontSizeCustom(double size) {
    ...
    final context = RunTrackerStepCounterWaterReminderScreensApp.navigatorKey.currentContext!;
  ...
  double get buttonHeight => ScreenUtil().setHeight(55);
}
