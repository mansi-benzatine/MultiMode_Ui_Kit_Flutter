import 'package:car_shop_screens_app_package/ui/onboarding/datamodel/onboarding_data.dart';
...
class OnboardingScreen extends StatefulWidget {
  ...
  static Route route({required int selectedIndex}) {
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void initState() {
    ...
    super.initState();
    currantPageIndex = widget.selectedIndex;
