...
class ViewSellerDetailScreen extends StatefulWidget {
  ...
  @override
  State<ViewSellerDetailScreen> createState() => _ViewSellerDetailScreenState();
}

class _ViewSellerDetailScreenState extends State<ViewSellerDetailScreen> implements TopBarClickListener {
  ...
  Widget _buildOfferHeader() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          CommonText(
            text: "${Languages.of(context).txtViewSellerDetailsOn} Tesla Model Y",
