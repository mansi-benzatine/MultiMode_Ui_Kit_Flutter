  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            TopBar(this, title: Languages.of(context).txtLanguage, isShowBack: true),
            // Search Bar
            _buildSearchBar(),
            Expanded(
  ...
  Widget _buildLanguageItem(LanguageModel language) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? CustomAppColor.of(context).primary.withValues(alpha: 0.1) : CustomAppColor.of(context).transparent,
          borderRadius: BorderRadius.circular(1000),
          border: Border.all(
        ...
        child: Row(
          children: [
            ...
            Text(
              language.symbol,
              style: TextStyle(fontSize: 24.setFontSize),
            ),
            ...
            Expanded(
              child: CommonText(
                ...
                textColor: isSelected ? CustomAppColor.of(context).tabSelectedTxtColor2 : CustomAppColor.of(context).txtBlack,
                textAlign: TextAlign.start,
              ),
            ),
            // Selection indicator
