import 'package:chat_ai_screens_app_package/ui/notification/datamodel/notification_data.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            IgnorePointer(ignoring: true, child: TopBar(this, title: Languages.of(context).txtNotification)),
            Expanded(
