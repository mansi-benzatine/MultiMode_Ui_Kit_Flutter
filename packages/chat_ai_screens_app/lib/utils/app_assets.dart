...
class AppAssets {
  static const _path = "packages/chat_ai_screens_app_package/";
  ...
  static String icHorizontalMore = "${_pIcons}ic_horizontal_more.webp";
  ...
  static String icAppleUnfilled = "${_pIcons}ic_apple_unfilled.webp";
