...
import 'package:taxi_booking_driver_screens_app_package/ui/app/my_app.dart';
...
extension SizeExtension on num {
  ...
  static double setFontSizeCustom(double size) {
    ...
    final context = TaxiBookingDriverScreensApp.navigatorKey.currentContext!;
...
// Add a helper method to detect foldable phones
  ...
  double get buttonHeight => ScreenUtil().setHeight(52);
}
