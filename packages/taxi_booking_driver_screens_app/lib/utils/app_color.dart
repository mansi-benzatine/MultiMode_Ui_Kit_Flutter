...
import 'package:taxi_booking_driver_screens_app_package/utils/utils.dart';
...
class CustomAppColor {
  ...
  Color get txtGreyWhite {
    return (Theme.of(context).brightness == Brightness.light) ? const Color(0xFFCFD1D3) : Colors.white;
  }
