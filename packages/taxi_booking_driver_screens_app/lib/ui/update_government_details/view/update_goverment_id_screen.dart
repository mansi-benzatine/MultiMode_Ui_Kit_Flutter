...
class UpdateGovernmentIdScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const UpdateGovernmentIdScreen());
  }

  const UpdateGovernmentIdScreen({super.key});

  @override
  State<UpdateGovernmentIdScreen> createState() => _UpdateGovernmentIdScreenState();
}

class _UpdateGovernmentIdScreenState extends State<UpdateGovernmentIdScreen> implements TopBarClickListener {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            TopBar(this, title: Languages.of(context).txtGovernmentId),
            Expanded(
              child: Column(
...
class _UploadFileViewState extends State<UploadFileView> {
  final List<PlatformFile> _selectedFiles = [
    PlatformFile(
      name: 'dummy_bank.png',
      size: 0,
      path: AppAssets.imgDummyLocalId,
      bytes: null,
    ),
  ];
