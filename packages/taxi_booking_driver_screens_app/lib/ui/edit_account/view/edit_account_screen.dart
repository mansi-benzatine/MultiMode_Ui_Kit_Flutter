...
class _EditAccountScreenState extends State<EditAccountScreen> implements TopBarClickListener {
  final firstNameController = TextEditingController(text: "Devin");
  final lastNameController = TextEditingController(text: "Jorje");
  final phoneController = TextEditingController(text: "12345 67890");
  final emailController = TextEditingController(text: "devin@yourdomain.com");
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: IgnorePointer(ignoring: true, child: CommonButton(text: Languages.of(context).txtUpdate)),
            )
          ],
        ),
      ),
