...
class UpdateBankDetailsScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const UpdateBankDetailsScreen());
  }
...
class _UpdateBankDetailsScreenState extends State<UpdateBankDetailsScreen> implements TopBarClickListener {
    ...
    instructionList = [
      {
        ...
        'title': Languages.of(context).txtUploadBankDocument,
      },
      {
        'icon': AppAssets.icTickMark,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            TopBar(this, title: Languages.of(context).txtBankDetails),
            Expanded(
              child: Column(
          ...
          if (_selectedFiles.isNotEmpty)
            Wrap(
              ...
              children: _selectedFiles.map((file) {
                if (file.extension == 'jpg' || file.extension == 'jpeg' || file.extension == 'png' || file.path!.startsWith('assets/')) {
                  return Stack(
