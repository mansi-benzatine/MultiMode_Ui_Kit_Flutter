...
import 'package:run_tracker_app/ui/achievements/views/achievements_screen.dart';
import 'package:run_tracker_app/ui/reminder/views/reminder_screen.dart';
import 'package:run_tracker_app/ui/subscription/views/subscription_screen.dart';
                      ...
                      return FlutterSwitch(
                        ...
                        onToggle: (bool newValue) {
                          ...
                          final newTheme = newValue
                              ? ThemeData.dark()
                              : ThemeData.light();
                          RunTrackerApp.changeTheme(context, newTheme);
                        },
