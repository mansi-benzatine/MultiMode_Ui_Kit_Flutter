...
import 'package:run_tracker_app/ui/expanded_map/views/expand_map_screen.dart';
...
class StartRunningDetailsScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => StartRunningDetailsScreen());
  }

  const StartRunningDetailsScreen({super.key});

  @override
  State<StartRunningDetailsScreen> createState() =>
      _StartRunningDetailsScreenState();
}

class _StartRunningDetailsScreenState extends State<StartRunningDetailsScreen>
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CommonText(
                  text: Languages.of(context).txtFinishDesc,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(
                      isLocked ? AppAssets.icLock : AppAssets.icLockOpen,
                      height: 20.setHeight,
                      width: 20.setWidth,
                      color: CustomAppColor.of(context).primary,
                    ),
        ...
        CommonText(
          text: isLocked
              ? Languages.of(context).txtSwipeLeftToUnlock.toUpperCase()
              : Languages.of(context).txtSwipeRightToLock.toUpperCase(),
