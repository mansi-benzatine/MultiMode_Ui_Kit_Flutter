...
import 'package:run_tracker_app/ui/loading_weekly_goal/views/loading_weekly_goal_screen.dart';
...
class FillInformationScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const FillInformationScreen());
  }
