...
import 'package:mantra_yoga_app_package/ui/app/my_app.dart';
...
class BottomBarWithCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint fillPaint = Paint()
      ..color = CustomAppColor.of(MantraYogaApp.navigatorKey.currentContext!).bottomBarBgColor
    ...
    Paint strokePaint = Paint()
      ..shader = LinearGradient(
        ...
        colors: [
          CustomAppColor.of(MantraYogaApp.navigatorKey.currentContext!).bottomBarBgColor,
          CustomAppColor.of(MantraYogaApp.navigatorKey.currentContext!).primary,
          CustomAppColor.of(MantraYogaApp.navigatorKey.currentContext!).bottomBarBgColor,
        ],
