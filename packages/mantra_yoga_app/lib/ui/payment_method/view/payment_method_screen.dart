...
class _PaymentMethodScreenState extends State<PaymentMethodScreen> implements TopBarClickListener {
  ...
  _itemOfOptionsView(
      {required String image, required String title, double? imageHeight, double? imageWidth, bool isShowEdit = true, Function()? onEditTap}) {
        ...
        return InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: (selectedPaymentMethod.value == title && widget.isFromSelection)
                  ? CustomAppColor.of(context).containerBorderAndBlack
                  : CustomAppColor.of(context).bgScreen,
