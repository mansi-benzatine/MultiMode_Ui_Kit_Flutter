                        ...
                        children: [
                          Expanded(
                            child: CommonButton(
                              ...
                              borderColor:
                                  value ? CustomAppColor.of(context).borderColor : CustomAppColor.of(context).txtDarkGray.withValues(alpha: 0.2),
                          ...
                          Expanded(
                            child: CommonButton(
                              ...
                              borderColor:
                                  value ? CustomAppColor.of(context).txtDarkGray.withValues(alpha: 0.2) : CustomAppColor.of(context).borderColor,
