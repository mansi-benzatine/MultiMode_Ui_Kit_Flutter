...
class YourTargatedWeightPage extends StatefulWidget {
  const YourTargatedWeightPage({super.key});

  @override
  State<YourTargatedWeightPage> createState() => _YourTargatedWeightPageState();
}

class _YourTargatedWeightPageState extends State<YourTargatedWeightPage> {
  ValueNotifier<int> selectedWeight = ValueNotifier(60);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        CommonText(
          text: Languages.of(context).txtSelectYourTargetedWeight,
