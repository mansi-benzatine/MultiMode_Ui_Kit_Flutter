import 'package:flowly_app/ui/onboarding/view/onboarding_screen.dart';
...
class FlowlyApp extends StatefulWidget {
  ...
  static void setLocale(BuildContext context, Locale newLocale) {
    _FlowlyAppState? state = context.findAncestorStateOfType<_FlowlyAppState>();
  ...
  const FlowlyApp({super.key, this.externalThemeData});
...
class _FlowlyAppState extends State<FlowlyApp> {
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return MaterialApp(
            navigatorKey: FlowlyApp.navigatorKey,
...
class FlowlyAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const FlowlyAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = FlowlyApp.navigatorKey.currentState;
        ...
        child: FlowlyApp(externalThemeData: themeData),
      ),
    );
  }
}
