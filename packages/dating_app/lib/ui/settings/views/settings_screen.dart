...
import 'package:dating_app_package/ui/app/my_app.dart';
import 'package:dating_app_package/ui/community_guidelines/views/community_guidelines_screen.dart';
import 'package:dating_app_package/ui/edit_profile/views/edit_profile_screen.dart';
import 'package:dating_app_package/ui/edit_system/views/edit_system_screen.dart';
import 'package:dating_app_package/ui/help_and_support/views/help_and_support_screen.dart';
import 'package:dating_app_package/ui/privacy_policy/views/privacy_policy_screen.dart';
import 'package:dating_app_package/ui/safety_tips/views/safety_tips_screen.dart';
import 'package:dating_app_package/ui/subscription/views/subscription_screen.dart';
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const UpgradeCardView(),
                      SizedBox(height: 20.setHeight),
                      const SystemInformationView(),
                      SizedBox(height: 20.setHeight),
                      ...
                      const AgeRangesView(),
                      SizedBox(height: 20.setHeight),
                      NotificationView(isDarkMode: isDarkMode, isPushNotification: _isPushNotification),
                      SizedBox(height: 20.setHeight),
                      const ContactUsView(),
                      SizedBox(height: 20.setHeight),
                      const CommunityView(),
                    ...
                    builder: (context, value, child) {
                      return FlutterSwitch(
                        ...
                        onToggle: (bool newValue) {
                          ...
                          DatingApp.changeTheme(context, newTheme);
                        },
