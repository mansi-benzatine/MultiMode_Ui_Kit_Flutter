...
import 'package:dating_app_package/ui/dashboard/views/dashboard_screen.dart';
...
class FillUpInformationScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const FillUpInformationScreen());
  }

  const FillUpInformationScreen({super.key});
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: CommonButton(
                text: _currentPage == totalPages - 1 ? Languages.of(context).txtStart.toUpperCase() : Languages.of(context).txtContinue.toUpperCase(),
                onTap: _nextPage,
              ),
            )
          ],
      ...
      child: Column(
        children: [
          Image.asset(
            ...
            color: isSelected ? CustomAppColor.of(context).txtPink : CustomAppColor.of(context).genderImageBg,
          ),
