...
class OTPTextField extends StatefulWidget {
  ...
  const OTPTextField(
      ...
      this.fieldHeight = 58,
      this.fieldWidth = 30,
      this.margin = const EdgeInsets.symmetric(horizontal: 3, vertical: 3),
      this.otpFieldStyle,
...
class _OTPTextFieldState extends State<OTPTextField> {
  ...
  void initState() {
    ...
    textFields = List.generate(widget.length, (int i) {
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          counterText: "",
          contentPadding: EdgeInsets.symmetric(vertical: 16.setHeight, horizontal: 0),
          border: _getBorder(_pin[i].isNotEmpty ? CustomAppColor.of(context).textFormFieldBorder : _otpFieldStyle.borderColor),
          focusedBorder: _getBorder(CustomAppColor.of(context).primary),
          enabledBorder: _getBorder(_pin[i].isNotEmpty ? CustomAppColor.of(context).primary : _otpFieldStyle.enabledBorderColor),
  ...
  InputBorder _getBorder(Color color) {
    return widget.fieldStyle == FieldStyle.box
        ? OutlineInputBorder(
            ...
            borderRadius: BorderRadius.circular(_otpFieldStyle.borderRadius),
          )
