...
class BabyBloomApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _BabyBloomAppState? state = context.findAncestorStateOfType<_BabyBloomAppState>();
  ...
  const BabyBloomApp({super.key, this.externalThemeData});

  @override
  State<BabyBloomApp> createState() => _BabyBloomAppState();
}

class _BabyBloomAppState extends State<BabyBloomApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: BabyBloomApp.navigatorKey,
...
class BabyBloomAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const BabyBloomAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = BabyBloomApp.navigatorKey.currentState;
        ...
        child: BabyBloomApp(externalThemeData: themeData),
      ),
    );
  }
}
