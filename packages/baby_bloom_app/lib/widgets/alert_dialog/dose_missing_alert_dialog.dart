...
class DoseMissingAlertDialog extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const DoseMissingAlertDialog());
  }

  const DoseMissingAlertDialog({super.key});

  @override
  State<DoseMissingAlertDialog> createState() => _DoseMissingAlertDialogState();
}

class _DoseMissingAlertDialogState extends State<DoseMissingAlertDialog> {
  @override
