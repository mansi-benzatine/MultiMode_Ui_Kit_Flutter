...
import 'package:baby_bloom_app/ui/notification_popup/view/notification_popup_screen.dart';
...
class AddEventBottomSheet extends StatefulWidget {
  ...
  const AddEventBottomSheet({super.key, this.date = "Wednesday, August 20"});
