...
class TransferAmountScreen extends StatefulWidget {
  ...
  static Route<void> route({required WishListItemData data}) {
    return MaterialPageRoute(
      builder: (_) => TransferAmountScreen(data: data),
    );
  }

  const TransferAmountScreen({super.key, required this.data});

  @override
  State<TransferAmountScreen> createState() => _TransferAmountScreenState();
}

class _TransferAmountScreenState extends State<TransferAmountScreen> implements TopBarClickListener {
