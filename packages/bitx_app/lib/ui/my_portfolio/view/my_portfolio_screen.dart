...
class MyPortfolioScreen extends StatefulWidget {
  static Route<void> route() {
    return MaterialPageRoute(builder: (_) => const MyPortfolioScreen());
  }
...
class _MyPortfolioScreenState extends State<MyPortfolioScreen> implements TopBarClickListener {
      ...
      body: SafeArea(
        child: Column(
          children: [
            TopBar(
              this,
              title: Languages.of(context).txtMyPortfolio,
              isShowBack: true,
              isShowSearch: true,
            ),
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: portfolioItems
                      .map(
                        (item) => Container(
                          decoration: BoxDecoration(border: Border(bottom: BorderSide(color: CustomAppColor.of(context).txtGray.withValues(alpha: 0.2)))),
