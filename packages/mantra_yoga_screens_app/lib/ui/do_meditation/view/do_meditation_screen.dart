...
class DoMeditationScreen extends StatefulWidget {
  final bool isForFullScreen;
  const DoMeditationScreen({super.key, this.isForFullScreen = false});

  static Route<dynamic> route({bool isForFullScreen = false}) {
    return MaterialPageRoute(
        builder: (context) => DoMeditationScreen(
              isForFullScreen: isForFullScreen,
            ));
  }
...
class _DoMeditationScreenState extends State<DoMeditationScreen> implements TopBarClickListener {
  ...
  void initState() {
    super.initState();
    isFullScreen.value = widget.isForFullScreen;
