...
import 'package:mantra_yoga_screens_app_package/ui/screens_list/view/screens_list_screen.dart';
...
class MantraYogaScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _MantraYogaScreensAppState? state = context.findAncestorStateOfType<_MantraYogaScreensAppState>();
  ...
  const MantraYogaScreensApp({super.key, this.externalThemeData});

  @override
  State<MantraYogaScreensApp> createState() => _MantraYogaScreensAppState();
}

class _MantraYogaScreensAppState extends State<MantraYogaScreensApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: MantraYogaScreensApp.navigatorKey,
...
class MantraYogaScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const MantraYogaScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = MantraYogaScreensApp.navigatorKey.currentState;
        ...
        child: MantraYogaScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
