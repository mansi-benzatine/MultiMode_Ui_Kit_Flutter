...
class _TrackOrderScreenState extends State<TrackOrderScreen> implements TopBarClickListener {
  late OrderTrackingModel orderTracking;

  void fillData() {
    orderTracking = OrderTrackingModel(
      orderId: "212454",
      ...
      trackingSteps: [
        TrackingStep(
          time: "9:30 AM",
          status: Languages.of(context).orderPlaced,
          description: Languages.of(context).yourOrderWasPlaced,
          isCompleted: true,
        ),
        TrackingStep(
          time: "9:35 AM",
          status: Languages.of(context).pending,
          description: Languages.of(context).yourOrderIsPendingForConfirmation,
          isCompleted: true,
        ),
        TrackingStep(
          time: "9:55 AM",
          status: Languages.of(context).confirmed,
          description: Languages.of(context).yourOrderIsConfirmed,
          isCompleted: true,
        ),
        TrackingStep(
          time: "",
          status: Languages.of(context).processing,
          description: Languages.of(context).yourProductIsProcessingToDeliverYouOnTime,
          isCompleted: false,
        ),
        TrackingStep(
          time: "",
          status: Languages.of(context).delivered,
          description: Languages.of(context).productDeliveredToYouAndMarkedAsDeliveredByCustomer,
          isCompleted: false,
        ),
      ],
    );
