...
class ForgotPasswordScreen extends StatefulWidget {
  ...
  const ForgotPasswordScreen({super.key, required this.isFromEmail});

  static Route route({required bool isFromEmail}) {
    return MaterialPageRoute(builder: (context) => ForgotPasswordScreen(isFromEmail: isFromEmail));
  }
...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void initState() {
    super.initState();
    isEmailSelected = widget.isFromEmail;
  }
