  ...
  void fillData() {
    accountList = [
      AccountData(
        ...
        label: Languages.of(context).myBankDetails,
        isSuffixIcon: true,
      ),
      AccountData(leadingIcon: AppAssets.icShare, label: Languages.of(context).mySharedCatalogs, isSuffixIcon: true),
      AccountData(leadingIcon: AppAssets.icRefer, label: Languages.of(context).referAndEarn, isSuffixIcon: false),
      AccountData(leadingIcon: AppAssets.icSetting, label: Languages.of(context).settings, isSuffixIcon: true),
      AccountData(leadingIcon: AppAssets.icNotificationBell, label: Languages.of(context).notificationSettings, isSuffixIcon: true),
      AccountData(leadingIcon: AppAssets.icRate, label: Languages.of(context).rateGozzy, isNavigate: true),
      AccountData(leadingIcon: AppAssets.icLogout, label: Languages.of(context).logout, isNavigate: true),
    ];
  }
