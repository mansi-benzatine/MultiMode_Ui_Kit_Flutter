...
import 'package:bitx_screens_app/ui/deposit_amount/view/deposit_amount_screen.dart';
...
class DepositeCoinScreen extends StatefulWidget {
  final WishListItemData data;

  static Route<void> route({required WishListItemData data}) {
    return MaterialPageRoute(builder: (_) => DepositeCoinScreen(data: data));
  }

  const DepositeCoinScreen({super.key, required this.data});

  @override
  State<DepositeCoinScreen> createState() => _DepositeCoinScreenState();
}

class _DepositeCoinScreenState extends State<DepositeCoinScreen> implements TopBarClickListener {
  @override
                ...
                Expanded(
                  child: IgnorePointer(
                    ...
                    child: CommonButton(
                      ...
                      onTap: () => Navigator.push(context, DepositAmountScreen.route(data: widget.data)),
                    ),
                  ),
                )
              ],
