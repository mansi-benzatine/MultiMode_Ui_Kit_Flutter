...
class SearchScreen extends StatefulWidget {
  ...
  static Route<void> route({bool forEmptyScreen = false}) {
    return MaterialPageRoute(
      builder: (_) => SearchScreen(forEmptyScreen: forEmptyScreen),
    );
  }

  const SearchScreen({super.key, this.forEmptyScreen = false});
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    widget.forEmptyScreen ? _emptySearch() : _recentSearch(),
                  ],
                ),
              ),
            ),
