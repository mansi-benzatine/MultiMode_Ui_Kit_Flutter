import 'package:bitx_screens_app/ui/screens_list/view/screens_list_screen.dart';
...
class BitXScreensApp extends StatefulWidget {
  final ThemeData? externalThemeData;
  static final navigatorKey = GlobalKey<NavigatorState>();

  static void setLocale(BuildContext context, Locale newLocale) {
    _BitXScreensAppState? state = context.findAncestorStateOfType<_BitXScreensAppState>();
  ...
  const BitXScreensApp({super.key, this.externalThemeData});

  @override
  State<BitXScreensApp> createState() => _BitXScreensAppState();
}

class _BitXScreensAppState extends State<BitXScreensApp> {
  Locale? _locale;
    ...
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp(
            navigatorKey: BitXScreensApp.navigatorKey,
...
class BitXScreensAppWrapper extends StatelessWidget {
  final ThemeData themeData;

  const BitXScreensAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = BitXScreensApp.navigatorKey.currentState;
        ...
        child: BitXScreensApp(externalThemeData: themeData),
      ),
    );
  }
}
