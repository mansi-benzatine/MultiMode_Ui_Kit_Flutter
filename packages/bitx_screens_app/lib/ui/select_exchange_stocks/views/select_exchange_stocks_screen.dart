...
import '../../../dialogs/alerts/order_exchange_received_dialog.dart';
...
class SelectExchangeStocksScreen extends StatefulWidget {
  ...
  static Route<void> route({bool forDetailsBs = false, bool forSuccessDialog = false}) {
    return MaterialPageRoute(
      builder: (_) => SelectExchangeStocksScreen(
  ...
  const SelectExchangeStocksScreen({super.key, this.forDetailsBs = false, this.forSuccessDialog = false});
            ...
            builder: (dialogContext) {
              return PopScope(
                ...
                child: OrderExchangeDialog(
                  icon1: AppAssets.icBtBtc,
                  icon2: AppAssets.icBtBnb,
                  title1: "BTC",
                  title2: "BNB",
                  onComplete: () {},
                ),
