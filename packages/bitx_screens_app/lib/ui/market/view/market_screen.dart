...
class MarketScreen extends StatefulWidget {
  ...
  static Route<void> route({String selectedTab = "", bool forEmptyScreen = false}) {
...
class _MarketScreenState extends State<MarketScreen> implements TopBarClickListener {
  ...
  void initState() {
    ...
    selectedCategory = widget.selectedTab;
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: widget.selectedTab == e ? CustomAppColor.of(context).primary : CustomAppColor.of(context).expertGraphBg,
                  ),
                  child: CommonText(
                    text: e,
                    textColor: widget.selectedTab == e ? CustomAppColor.of(context).white : CustomAppColor.of(context).txtBlack,
                    fontWeight: FontWeight.w500,
                  ),
                ),
              ),
