...
import 'package:bitx_screens_app/ui/onboarding/datamodel/onboarding_data.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void initState() {
    ...
    super.initState();
    currantPageIndex.value = widget.currentIndex;

    pageController = PageController(viewportFraction: 1.0, keepPage: true, initialPage: widget.currentIndex);
  }
