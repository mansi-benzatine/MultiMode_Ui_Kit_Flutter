    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: gradient == null ? buttonColor ?? CustomAppColor.of(context).primary : null,
        ...
        child: InkWell(
          ...
          overlayColor: WidgetStateProperty.all(CustomAppColor.of(context).bgScreen),
          child: Row(
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(
                      ...
                      color: imageColor,
                      height: imageSize ?? 25.setHeight,
                      width: imageSize ?? 25.setHeight,
                    ),
                  ),
                ),
              },
