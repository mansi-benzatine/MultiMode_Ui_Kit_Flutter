      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            filled: true,
            fillColor: fillColor ?? CustomAppColor.of(context).bgScaffold,
            hintText: hintText,
            hintStyle: TextStyle(
              fontSize: 15.setFontSize,
            ...
            border: OutlineInputBorder(
              borderSide: BorderSide(width: 2, color: CustomAppColor.of(context).grey.withValues(alpha: 0.2)),
            ),
            enabledBorder: OutlineInputBorder(
              borderSide: BorderSide(width: 2, color: borderColor ?? CustomAppColor.of(context).grey.withValues(alpha: 0.2)),
            ),
            focusedBorder: OutlineInputBorder(
              borderSide: BorderSide(width: 2, color: CustomAppColor.of(context).primary),
            ),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            contentPadding: EdgeInsets.only(right: 20.setWidth, left: 20.setWidth, top: 15.setHeight, bottom: 15.setHeight),
            border: OutlineInputBorder(
              borderSide: BorderSide(width: 1, color: CustomAppColor.of(context).grey.withValues(alpha: 0.2)),
            ),
            enabledBorder: OutlineInputBorder(
              borderSide: BorderSide(width: 1, color: CustomAppColor.of(context).grey.withValues(alpha: 0.2)),
            ),
            focusedBorder: OutlineInputBorder(
              borderSide: BorderSide(width: 1, color: CustomAppColor.of(context).primary),
            ),
            focusedErrorBorder: OutlineInputBorder(
              borderSide: BorderSide(width: 1, color: CustomAppColor.of(context).primary),
            ),
