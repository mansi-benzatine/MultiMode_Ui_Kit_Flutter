...
import 'package:food_delivery_app_package/ui/edit_account/views/edit_account_screen.dart';
import 'package:food_delivery_app_package/ui/feedback/views/feedback_screen.dart';
import 'package:food_delivery_app_package/ui/helps_and_support/views/helps_and_support_screen.dart';
import 'package:food_delivery_app_package/ui/my_account/views/my_account_screen.dart';
import 'package:food_delivery_app_package/ui/past_order/views/past_orders_screen.dart';
import 'package:food_delivery_app_package/ui/payment/views/payment_screen.dart';
import 'package:food_delivery_app_package/ui/re_order/views/re_order_screen.dart';
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    NavigationOptionsListView(navigationList: navigationList),
                    SizedBox(height: 8.setHeight),
                    const PastOrderView(),
                    SizedBox(height: 8.setHeight),
                    const LogOutView(),
