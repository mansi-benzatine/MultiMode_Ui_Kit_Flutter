...
import 'package:food_delivery_app_package/ui/on_boarding/views/on_boarding_screen.dart';
...
class FoodDeliveryApp extends StatefulWidget {
  ...
  static void setLocale(BuildContext context, Locale newLocale) {
    _FoodDeliveryAppState? state = context.findAncestorStateOfType<_FoodDeliveryAppState>();
  ...
  const FoodDeliveryApp({super.key, this.externalThemeData});
...
class _FoodDeliveryAppState extends State<FoodDeliveryApp> {
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      ...
      builder: (_, __) {
        return MaterialApp(
          navigatorKey: FoodDeliveryApp.navigatorKey,
...
class FoodDeliveryAppWrapper extends StatelessWidget {
  final ThemeData themeData;
  const FoodDeliveryAppWrapper({super.key, required this.themeData});
    ...
    return Theme(
      ...
      child: PopScope(
        ...
        onPopInvokedWithResult: (didPop, result) {
          if (didPop) return;
          final navigator = FoodDeliveryApp.navigatorKey.currentState;
        ...
        child: FoodDeliveryApp(externalThemeData: themeData),
      ),
    );
  }
}
