...
import 'package:food_delivery_app_package/ui/apply_coupon/views/apply_coupon_screen.dart';
import 'package:food_delivery_app_package/ui/proceed_to_pay/views/proceed_to_pay_screen.dart';
...
import '../../manage_address/views/manage_address_screen.dart';

class ViewCartScreen extends StatefulWidget {
  final bool isFromDashBoard;
  const ViewCartScreen({super.key, required this.isFromDashBoard});

  static Route<void> route({required bool isFromDashboard}) {
    return MaterialPageRoute(builder: (_) => ViewCartScreen(isFromDashBoard: isFromDashboard));
  }
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            if (!isCartEmpty) ProceedToPayView(foodList: addedItemList),
          ],
        ),
      ),
    );
