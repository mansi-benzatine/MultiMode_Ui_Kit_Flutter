...
import 'package:food_delivery_app_package/ui/view_restaurant/datamodels/view_restaurant_data.dart';
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () => Navigator.push(context, ViewCartScreen.route(isFromDashboard: false)),
                child: Row(
                  children: [
                    CommonText(
