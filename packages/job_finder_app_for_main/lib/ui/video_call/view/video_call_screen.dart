...
class VideoCallScreen extends StatelessWidget {
  ...
  static Route<void> route({required String userName}) {
    return MaterialPageRoute(builder: (_) => VideoCallScreen(userName: userName));
  }
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
          ...
          body: Stack(
            children: [
              IncomingCallView(userName: userName),
              Positioned(
                top: 59.setHeight,
                left: 23.setWidth,
                child: IconButton(
...
class IncomingCallView extends StatelessWidget {
  final String userName;
  const IncomingCallView({super.key, required this.userName});
