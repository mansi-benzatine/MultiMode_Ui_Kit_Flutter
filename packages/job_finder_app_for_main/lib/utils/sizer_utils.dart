...
import 'package:job_finder_app_package_for_main/ui/app/my_app.dart';
...
extension SizeExtension on num {
  ...
  static double setFontSizeCustom(double size) {
    ...
    final context = JobFinderAppForMain.navigatorKey.currentContext!;
...
// Add a helper method to detect foldable phones
  ...
  double get buttonHeight => ScreenUtil().setHeight(60);
}
