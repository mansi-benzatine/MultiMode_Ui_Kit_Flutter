...
class AppAssets {
  //Remove _p
  static const _path = "packages/job_finder_app_package_for_main/";
  ...
  static void refreshAssets(BuildContext context) {
    ...
    themeIcons = (brightness == Brightness.light) ? _pIcons : _pDarkIcons;
    themeImages = (brightness == Brightness.light) ? _pImages : _pDarkImages;
  ...
  // Optional helper if you want to get path directly without using refresh
  static String getIcons(BuildContext context) => Theme.of(context).brightness == Brightness.light ? _pIcons : _pDarkIcons;

  static String getImages(BuildContext context) => Theme.of(context).brightness == Brightness.light ? _pImages : _pDarkImages;
...
// static const icBottomBarHistory = "${_pIcons}ic_bottom_bar_history.webp";
  ...
  static const icWhiteLocations = "${_pIcons}ic_white_location.webp";
